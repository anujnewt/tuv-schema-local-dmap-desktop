...
null,null,null,null,null,null,'PEND',clock_timestamp(),clock_timestamp(),p_usuario,0,1,p_cod_cliente
)
returning folio_recibo_manual into id_registro;
call feci_modifica_tipo_cambio_recibo_pr (id_registro, 'MANUAL', p_usuario);
