create or replace procedure feci."feci_modifica_recibo_por_lotes_pr"  () as $body$
declare
-- pgv moved types end
...
where nullif(fec_tc_origen::text, '') is null and nullif(tipo_cambio_dolar::text, '') is null;/* dmap converted statement start */
begin
