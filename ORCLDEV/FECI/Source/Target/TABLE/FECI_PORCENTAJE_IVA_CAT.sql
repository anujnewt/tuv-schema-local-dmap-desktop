...
id_porcentaje_iva  bigint generated always as identity  (start with 1 increment by 1  maxvalue 999999999999999999 minvalue 1 no cycle cache 20 ),
...
-- dmap_object_gen_tag : type : alter table name : feci_porcentaje_iva_cat
set search_path = feci,oracle,dmap_extension,public;
alter table feci_porcentaje_iva_cat alter column num_valor set not null;
-- dmap_object_gen_tag : type : alter table name : feci_porcentaje_iva_cat
set search_path = feci,oracle,dmap_extension,public;
