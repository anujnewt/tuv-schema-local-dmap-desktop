...
inner join feci_recibos_rep_vw rec on cls.folio_recibo = rec.folio_recibo and cls.tipo_recibo = rec.tipo_recibo
...
where rec.cod_estado_recibo = 'APLC' and cls.ind_estado = 1
--where rec.ind_estado = 1 and cls.ind_estado = 1 and rec.cod_estado_recibo = 'APLC' and gfc.ind_estado = 1
;/* dmap converted statement end */
-- estimed cost of view [ feci_clasificaciones_rep_vw ]: 1.00;
