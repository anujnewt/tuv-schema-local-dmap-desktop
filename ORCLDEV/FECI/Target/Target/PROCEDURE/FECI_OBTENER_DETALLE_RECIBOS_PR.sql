create or replace procedure feci."feci_obtener_detalle_recibos_pr"  ( p_folio varchar , p_tipo varchar ) as $body$
declare
...
from feci_recibos_vw a
left join feci_usuario_tab b on a.id_usuario_clasificacion = b.id_usuario
left join feci_usuario_tab c on a.id_usuario_aplicacion = c.id_usuario
