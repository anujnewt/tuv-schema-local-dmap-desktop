create or replace procedure feci."feci_inserta_relacion_seg_concep_pr"  ( p_id_segmento numeric, p_forecast numeric, p_conceptos varchar, p_usuario numeric ) as $body$
declare
