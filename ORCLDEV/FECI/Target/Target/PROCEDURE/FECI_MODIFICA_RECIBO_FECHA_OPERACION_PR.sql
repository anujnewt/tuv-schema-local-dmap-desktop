create or replace procedure feci."feci_modifica_recibo_fecha_operacion_pr"  ( p_folio varchar, p_fecha_tc timestamp(0), p_codigo_mon varchar, p_codigo_est varchar, p_tipo_recibo varchar ) as $body$
declare
