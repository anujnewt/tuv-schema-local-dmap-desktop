create or replace procedure feci."feci_modifica_tipo_cambio_recibo_masivo_pr"  (p_usuario numeric) as $body$
declare
...
v_folio feci_recibos_vw.folio_recibo%type;
v_tipo feci_recibos_vw.tipo_recibo%type;
begin
...
call feci_modifica_tipo_cambio_recibo_pr (v_folio, v_tipo, p_usuario);
end loop;end;
$body$
language plpgsql
;
