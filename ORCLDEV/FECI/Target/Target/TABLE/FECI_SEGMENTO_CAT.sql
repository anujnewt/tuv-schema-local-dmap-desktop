...
id_segmento  bigint generated always as identity  (start with 1 increment by 1  maxvalue 999999999999999999 minvalue 1 no cycle cache 20 ),
...
-- dmap_object_gen_tag : type : alter table name : feci_segmento_cat
set search_path = feci,oracle,dmap_extension,public;
alter table feci_segmento_cat alter column ind_pais set not null;
-- dmap_object_gen_tag : type : alter table name : feci_segmento_cat
set search_path = feci,oracle,dmap_extension,public;
