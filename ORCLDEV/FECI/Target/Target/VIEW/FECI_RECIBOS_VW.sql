...
--concat('-M',  lpad(rec.folio_recibo_manual::text,  5,  '0'::text)) as folio_recibo
--rec.folio_recibo_manual   as folio_recibo
to_char(rec.folio_recibo_manual::text) as folio_recibo
...
-- estimed cost of view [ feci_recibos_vw ]: 1.20;
