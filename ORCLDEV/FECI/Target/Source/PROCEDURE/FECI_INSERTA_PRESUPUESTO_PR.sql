CREATE OR REPLACE EDITIONABLE PROCEDURE "FECI"."FECI_INSERTA_PRESUPUESTO_PR" 
(
        p_CODIGO_SEGMENTO               VARCHAR2,
        p_CODIGO_CONCEPTO               VARCHAR2,
        p_CODIGO_REGION                 VARCHAR2 DEFAULT NULL,
...
-- Verificar si ya existe un registro con la fecha especificada
    IF p_CODIGO_REGION IS NULL THEN
