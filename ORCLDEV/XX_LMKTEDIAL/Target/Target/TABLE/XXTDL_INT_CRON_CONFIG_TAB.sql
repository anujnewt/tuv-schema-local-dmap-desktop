-- dmap_object_gen_tag : type : table name : xxtdl_int_cron_config_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
create table "xxtdl_int_cron_config_tab"  (
id_configuration numeric not null,
id_service numeric,
...
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_cron_config_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
alter table xxtdl_int_cron_config_tab add primary key (id_configuration);
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_cron_config_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
alter table xxtdl_int_cron_config_tab alter column fec_creation_date set not null;
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_cron_config_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
alter table xxtdl_int_cron_config_tab alter column num_created_by set not null;
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_cron_config_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
alter table xxtdl_int_cron_config_tab alter column fec_last_update_date set not null;
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_cron_config_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
alter table xxtdl_int_cron_config_tab alter column num_last_updated_by set not null;
