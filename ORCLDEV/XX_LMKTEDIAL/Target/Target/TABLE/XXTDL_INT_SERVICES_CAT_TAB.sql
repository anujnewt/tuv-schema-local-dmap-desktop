-- dmap_object_gen_tag : type : table name : xxtdl_int_services_cat_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
create table "xxtdl_int_services_cat_tab"  (
...
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_services_cat_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
alter table xxtdl_int_services_cat_tab add primary key (id_service);
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_services_cat_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
alter table xxtdl_int_services_cat_tab alter column fec_creation_date set not null;
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_services_cat_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
alter table xxtdl_int_services_cat_tab alter column num_created_by set not null;
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_services_cat_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
alter table xxtdl_int_services_cat_tab alter column fec_last_update_date set not null;
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_services_cat_tab
set search_path = xx_lmktedial,oracle,dmap_extension,public;
alter table xxtdl_int_services_cat_tab alter column num_last_updated_by set not null;
