CREATE OR REPLACE EDITIONABLE PROCEDURE "USRSIHO"."SP_HPGPORAP3" (wn_keypro NUMBER,
...
BEGIN
   ...
   FOR rec IN (SELECT pol_keypro,        --cry_dec006 Integer   wn_keypro
         ...
         GROUP BY pol_keypro,pro_despro,pol_keyapr,pam_nompar,pol_keynom,nom_destip,pol_numemi,pol_fecpol,pol_usugen,
                  ...
                  pol_abopas,pol_carpas,substr(det_cuenta,2,9)
         ORDER BY pol_keyemp,ben_keyben,det_keypol,substr(det_cuenta,2,9)) LOOP
