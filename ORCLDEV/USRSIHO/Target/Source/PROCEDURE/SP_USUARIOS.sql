CREATE OR REPLACE EDITIONABLE PROCEDURE "USRSIHO"."SP_USUARIOS" (wn_key_usu IN NUMBER, ws_nom_usu IN VARCHAR2,
...
-- PGV moved types end
    ...
    ws_hor_mov VARCHAR2(5) := SUBSTR (USRSIHO.sp_glgethor, 1, 5);
BEGIN
    INSERT INTO USRSIHO.glcousua
...
EXCEPTION
    WHEN OTHERS THEN
        USRSIHO.sp_glGenErr ('USUARIOS', 'ID DE PC', 0, USRSIHO.sp_glgethor, SQLCODE, 0, SUBSTR (SQLERRM, 1, 60));
END;
/
