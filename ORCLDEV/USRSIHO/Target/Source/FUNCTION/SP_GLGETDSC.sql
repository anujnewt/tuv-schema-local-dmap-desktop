CREATE OR REPLACE EDITIONABLE FUNCTION "USRSIHO"."SP_GLGETDSC" (ws_key_tab IN VARCHAR2, ws_key_cam IN VARCHAR2,
...
-- PGV moved types end
    ...
    ws_val_etq USRSIHO.glcocamp.cam_descor%TYPE := SUBSTR (ws_des_def, 1, 8);
BEGIN
    SELECT cam_descor
      INTO ws_val_etq
