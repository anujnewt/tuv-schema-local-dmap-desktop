create or replace procedure usrsiho."sp_hpgpfaor2"  (wn_keypro numeric, ws_keyapr varchar,wn_keynom numeric,wn_numemi numeric,ws_tippol varchar, ws_nomrep varchar,ws_idepcc varchar,wn_keyusu numeric,ws_status varchar) as $body$
declare
...
det_sec_sindical,pol_abopas,pol_carpas,oracle.substr(det_cuenta,9,14)
order by  pol_keyemp,det_keyfol,oracle.substr(det_cuenta,9,14)) loop
