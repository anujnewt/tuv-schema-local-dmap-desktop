create or replace procedure usrsiho."sp_hpgporap1"  (wn_keypro numeric, ws_keyapr varchar,wn_keynom numeric,wn_numemi numeric,ws_tippol varchar, ws_nomrep varchar,ws_idepcc varchar,wn_keyusu numeric,ws_status varchar) as $body$
declare
...
pol_tippol,pol_forpag,pol_tipcam,pol_fpafin,oracle.substr(det_cuenta,2,9)
order by  oracle.substr(det_cuenta,2,9)) loop
