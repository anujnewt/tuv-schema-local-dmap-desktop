create or replace procedure usrsiho."sp_hnmrepla2"  (vs_nom_rep varchar,vs_ide_pcc varchar, vn_key_usu numeric) as $body$
declare
ora2pg_rowcount int;
...
gdp_capfin, (gdp_numcap*gdp_cosuni::numeric) cos_tot
...
set
cry_chr017 = vs_key_con, cry_chr002 = vs_des_con, cry_chr008 = vs_key_dep,
cry_chr009 = oracle.substr(vs_des_dep,1,20), cry_dec001 = vn_imp_ort
where cry_nomrep = vs_nom_rep
and cry_idepcc = vs_ide_pcc
and cry_keyusu = vn_key_usu
and cry_dec006 = vn_key_emp
