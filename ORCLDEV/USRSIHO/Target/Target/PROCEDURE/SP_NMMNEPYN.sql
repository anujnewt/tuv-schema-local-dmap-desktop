create or replace procedure usrsiho."sp_nmmnepyn"  (ws_nom_rep varchar, ws_ide_pcc varchar, wn_key_usu numeric, ws_key_men varchar, ws_hor_reg varchar, wn_key_pro numeric, ws_des_pro varchar, wn_key_nom numeric, ws_des_nom varchar) as $body$
declare
...
ws_etq_001 varchar(8)  := usrsiho.sp_glgetdsc('nmloform', 'for_keyfor', '........',    null);
ws_etq_002 varchar(40) := usrsiho.sp_glgetdsl('nmloform', 'for_numins', '........',    null);
ws_etq_003 varchar(40) := usrsiho.sp_glgetdsl('nmloenfm', 'enf_de1for', 'DESCRIPCION', null);
ws_etq_004 varchar(8)  := usrsiho.sp_glgetdsc('nmlomnem', 'mne_keynem', 'MNEMONIC',    null);
ws_etq_005 varchar(8)  := usrsiho.sp_glgetdsc('nmlocxpr', 'cxp_keypro', 'PROCESO',     null);
ws_etq_006 varchar(8)  := usrsiho.sp_glgetdsc('nmlocxpr', 'cxp_keynom', 'NOMINA',      null);
...
ws_des_lis varchar(50)    := usrsiho.sp_glgetrep('nmmneref', 'No existe nombre del Reporte', null);
...
c_desfor record;
begin
call usrsiho.sp_glfechor (ws_fec_act,ws_hor_act);
ws_des_cor := 'CORPORATIVO NO REGISTRADO ...';
begin
select cor_descor
into strict ws_des_cor
from usrsiho.glcocorp;
...
insert into usrsiho.glwkcrys(cry_nomrep, cry_idepcc, cry_keyusu, cry_chr001, cry_chr008,
