-- dmap_object_gen_tag : type : table name : hrepejec
set search_path = usrsiho,oracle,dmap_extension,public;
create table "hrepejec"  (
...
-- dmap_object_gen_tag : type : alter table name : hrepejec
set search_path = usrsiho,oracle,dmap_extension,public;
alter table hrepejec alter column eje_keynom set not null;
-- dmap_object_gen_tag : type : alter table name : hrepejec
set search_path = usrsiho,oracle,dmap_extension,public;
alter table hrepejec alter column eje_numemi set not null;
-- dmap_object_gen_tag : type : alter table name : hrepejec
set search_path = usrsiho,oracle,dmap_extension,public;
alter table hrepejec alter column eje_keyapr set not null;
-- dmap_object_gen_tag : type : alter table name : hrepejec
set search_path = usrsiho,oracle,dmap_extension,public;
alter table hrepejec alter column eje_nummes set not null;
-- dmap_object_gen_tag : type : alter table name : hrepejec
set search_path = usrsiho,oracle,dmap_extension,public;
alter table hrepejec alter column eje_keyemp set not null;
-- dmap_object_gen_tag : type : alter table name : hrepejec
set search_path = usrsiho,oracle,dmap_extension,public;
alter table hrepejec alter column eje_keydep set not null;
-- dmap_object_gen_tag : type : alter table name : hrepejec
set search_path = usrsiho,oracle,dmap_extension,public;
alter table hrepejec alter column eje_keypue set not null;
