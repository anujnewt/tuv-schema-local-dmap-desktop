-- dmap_object_gen_tag : type : table name : holohgdp
set search_path = usrsiho,oracle,dmap_extension,public;
create table "holohgdp"  (
...
-- dmap_object_gen_tag : type : alter table name : holohgdp
set search_path = usrsiho,oracle,dmap_extension,public;
alter table holohgdp add constraint pk_holohgdp primary key (hgd_keysec);
