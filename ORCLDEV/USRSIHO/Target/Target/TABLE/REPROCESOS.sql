-- dmap_object_gen_tag : type : table name : reprocesos
...
-- dmap_object_gen_tag : type : alter table name : reprocesos
set search_path = usrsiho,oracle,dmap_extension,public;
alter table reprocesos alter column rep_ejercicio set not null;
