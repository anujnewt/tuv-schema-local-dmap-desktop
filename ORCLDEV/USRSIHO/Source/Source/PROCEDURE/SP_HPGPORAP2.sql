CREATE OR REPLACE EDITIONABLE PROCEDURE "USRSIHO"."SP_HPGPORAP2" (wn_keypro NUMBER,
...
BEGIN
   ...
   FOR rec IN (SELECT pol_keypro,        --cry_dec006 Integer   wn_keypro
                  ...
                  substr(det_cuenta,2,9) cuenta,  --cry_chr008 VARCHAR2(20)  ws_cuenta
         ...
         GROUP BY pol_keypro,pro_despro,pol_keyapr,pam_nompar,pol_keynom,nom_destip,pol_numemi,pol_fecpol,pol_usugen,
                  ...
                  det_sec_sindical,pol_abopas,pol_carpas,substr(det_cuenta,2,9)
         ORDER BY pol_keyemp,det_keyfol,substr(det_cuenta,2,9)) LOOP
