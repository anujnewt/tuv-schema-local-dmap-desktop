CREATE OR REPLACE EDITIONABLE PROCEDURE "USRSIHO"."SP_HPGPORAP1" (wn_keypro NUMBER,
...
BEGIN
   ...
   FOR rec IN (SELECT pol_keypro,        --cry_dec006 Integer   wn_keypro
         ...
         GROUP BY pol_keypro,pro_despro,pol_keyapr,pam_nompar,pol_keynom,nom_destip,pol_numemi,pol_fecpol,pol_usugen,usu_nomusu,
            pol_tippol,pol_forpag,pol_tipcam,pol_fpafin,substr(det_cuenta,2,9)
         ORDER BY substr(det_cuenta,2,9)) LOOP
