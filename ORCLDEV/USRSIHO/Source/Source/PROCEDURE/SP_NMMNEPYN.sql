CREATE OR REPLACE EDITIONABLE PROCEDURE "USRSIHO"."SP_NMMNEPYN" (ws_nom_rep IN VARCHAR2,   ws_ide_pcc IN VARCHAR2,
...
-- PGV moved types end
    ...
    ws_etq_001 VARCHAR2(8)  := USRSIHO.sp_glgetdsc ('nmloform', 'for_keyfor', '........',    NULL);
    ws_etq_002 VARCHAR2(40) := USRSIHO.sp_glgetdsl ('nmloform', 'for_numins', '........',    NULL);
    ws_etq_003 VARCHAR2(40) := USRSIHO.sp_glgetdsl ('nmloenfm', 'enf_de1for', 'DESCRIPCION', NULL);
    ws_etq_004 VARCHAR2(8)  := USRSIHO.sp_glgetdsc ('nmlomnem', 'mne_keynem', 'MNEMONIC',    NULL);
    ws_etq_005 VARCHAR2(8)  := USRSIHO.sp_glgetdsc ('nmlocxpr', 'cxp_keypro', 'PROCESO',     NULL);
    ws_etq_006 VARCHAR2(8)  := USRSIHO.sp_glgetdsc ('nmlocxpr', 'cxp_keynom', 'NOMINA',      NULL);
    ...
    ws_des_lis VARCHAR2(50)    := USRSIHO.sp_glgetrep ('nmmneref', 'No existe nombre del Reporte', NULL);
    wn_con_reg NUMBER(3) := 0;
    wn_lim_ite NUMBER(3) := 100;
BEGIN
    USRSIHO.sp_glfechor(ws_fec_act,ws_hor_act);
