CREATE OR REPLACE EDITIONABLE FUNCTION "USRSIHO"."SP_GLGETREP" (ws_nom_rep IN VARCHAR2, ws_des_def IN VARCHAR2,
...
-- PGV moved types start
-- PGV moved types end
    ws_des_lis USRSIHO.glcolist.lis_deslis%TYPE := SUBSTR (ws_des_def, 1, 50);
BEGIN
