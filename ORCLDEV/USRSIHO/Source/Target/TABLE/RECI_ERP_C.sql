-- dmap_object_gen_tag : type : table name : reci_erp_c
set search_path = usrsiho,oracle,dmap_extension,public;
create table "reci_erp_c"  (
...
-- dmap_object_gen_tag : type : alter table name : reci_erp_c
set search_path = usrsiho,oracle,dmap_extension,public;
alter table reci_erp_c alter column rec_cvepol set not null;
-- dmap_object_gen_tag : type : alter table name : reci_erp_c
set search_path = usrsiho,oracle,dmap_extension,public;
alter table reci_erp_c alter column rec_fecpag set not null;
