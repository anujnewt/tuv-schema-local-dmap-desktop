create or replace  function  usrsiho."sp_glgetdsc"  (ws_key_tab varchar, ws_key_cam varchar, ws_des_def varchar, wn_lon_max numeric) returns varchar as $body$
declare
-- pgv moved types start
-- pgv moved types end
-- variables para la carga de la tabla de conceptos por proceso.
ws_val_etq usrsiho.glcocamp.cam_descor%type := oracle.substr(ws_des_def, 1, 8);
begin
select cam_descor
