create or replace  function  usrsiho."sp_hocalctiext"  (pi_entrada numeric, pi_salida numeric, pi_comida numeric, pi_capini numeric, pi_capfin numeric, ps_programa varchar, pl_keyfol numeric, pl_keypue varchar, pd_costo numeric, pi_keytco numeric, pi_keyemp numeric, pd_fecgra timestamp(0)) returns numeric as $body$
--                                pi_detserial number)
declare
...
-- let li_tieext = pd_costo * li_numcap * li_minext * 2 / ld_nfactor;
