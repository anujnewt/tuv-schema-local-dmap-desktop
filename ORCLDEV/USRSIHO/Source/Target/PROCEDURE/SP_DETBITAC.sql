create or replace procedure usrsiho."sp_detbitac"  (wn_key_usu numeric, ws_ide_pcc varchar, ws_key_tab varchar, ws_key_cam varchar, ws_val_ant varchar, ws_val_act varchar) as $body$
declare
-- pgv moved types start
-- pgv moved types end
ws_fec_mov timestamp(0)     := "usrsiho".sp_glgetfec;
ws_hor_mov varchar(16) := "usrsiho".sp_glgethor;
...
insert into "usrsiho".glcodetb(det_keyusu, det_fecmov, det_hormov, det_keytab,
