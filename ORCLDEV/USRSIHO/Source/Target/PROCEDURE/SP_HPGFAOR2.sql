create or replace procedure usrsiho."sp_hpgfaor2"  (wn_keypro numeric, ws_keyapr varchar,wn_keynom numeric,wn_numemi numeric,ws_tippol varchar, ws_nomrep varchar,ws_idepcc varchar,wn_keyusu numeric,ws_status varchar) as $body$
declare
