create or replace procedure usrsiho."sp_bitacora"  (wn_key_usu numeric, ws_log_usu varchar, ws_ide_pcc varchar, ws_tip_mov varchar, ws_key_001 varchar, ws_key_002 varchar, ws_key_003 varchar, ws_val_001 varchar, ws_val_002 varchar, ws_val_003 varchar, ws_des_men varchar) as $body$
declare
-- pgv moved types start
-- pgv moved types end
ws_fec_mov timestamp(0) := trunc(clock_timestamp());
...
insert into usrsiho.glwkcrys(cry_nomrep, cry_idepcc, cry_keyusu, cry_dat001, cry_chr012)
values (ws_ide_bit, ws_ide_pcc, wn_key_usu, ws_fec_mov, ws_hor_mov);
insert into usrsiho.glcobita(bit_keyusu, bit_logusu, bit_idepcc, bit_fecmov, bit_hormov,
