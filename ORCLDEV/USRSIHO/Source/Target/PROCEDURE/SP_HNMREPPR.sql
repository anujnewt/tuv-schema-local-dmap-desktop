create or replace procedure usrsiho."sp_hnmreppr"  (vs_nom_rep varchar,vs_ide_pcc varchar, vn_key_usu numeric) as $body$
declare
...
pam_nompar, cia_keycia, oracle.substr(cia_descia,1,40), gdp_keyemp,
case when frp_tipcam=1.0000 then 'Pesos'  else 'Dolares' end ,
(gdp_cosuni::numeric/frp_tipcam::numeric), frp_tipcam
