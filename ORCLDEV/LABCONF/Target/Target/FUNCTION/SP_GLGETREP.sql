create or replace  function  labconf."sp_glgetrep"  (ws_nom_rep varchar, ws_des_def varchar, wn_lon_max numeric) returns varchar as $body$
declare
-- pgv moved types start
-- pgv moved types end
ws_des_lis glcolist.lis_deslis%type := oracle.substr(ws_des_def, 1, 50);
c_deslis record;
begin
