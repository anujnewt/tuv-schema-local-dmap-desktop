-- dmap_object_gen_tag : type : table name : nmlohism_bak
set search_path = labconf,oracle,dmap_extension,public;
create table "nmlohism_bak"  (
...
-- dmap_object_gen_tag : type : alter table name : nmlohism_bak
set search_path = labconf,oracle,dmap_extension,public;
alter table nmlohism_bak alter column his_keyemp set not null;
-- dmap_object_gen_tag : type : alter table name : nmlohism_bak
set search_path = labconf,oracle,dmap_extension,public;
alter table nmlohism_bak alter column his_keycon set not null;
-- dmap_object_gen_tag : type : alter table name : nmlohism_bak
set search_path = labconf,oracle,dmap_extension,public;
alter table nmlohism_bak alter column his_keypro set not null;
-- dmap_object_gen_tag : type : alter table name : nmlohism_bak
set search_path = labconf,oracle,dmap_extension,public;
alter table nmlohism_bak alter column his_keyper set not null;
