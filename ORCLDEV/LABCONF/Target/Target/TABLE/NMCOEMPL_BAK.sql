-- dmap_object_gen_tag : type : table name : nmcoempl_bak
set search_path = labconf,oracle,dmap_extension,public;
create table "nmcoempl_bak"  (
...
-- dmap_object_gen_tag : type : alter table name : nmcoempl_bak
set search_path = labconf,oracle,dmap_extension,public;
alter table nmcoempl_bak alter column emp_keyemp set not null;
-- dmap_object_gen_tag : type : alter table name : nmcoempl_bak
set search_path = labconf,oracle,dmap_extension,public;
alter table nmcoempl_bak alter column emp_nomemp set not null;
-- dmap_object_gen_tag : type : alter table name : nmcoempl_bak
set search_path = labconf,oracle,dmap_extension,public;
alter table nmcoempl_bak alter column emp_keypro set not null;
-- dmap_object_gen_tag : type : alter table name : nmcoempl_bak
set search_path = labconf,oracle,dmap_extension,public;
alter table nmcoempl_bak alter column emp_status set not null;
