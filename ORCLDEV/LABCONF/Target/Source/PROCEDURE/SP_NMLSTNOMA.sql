CREATE OR REPLACE EDITIONABLE PROCEDURE "LABCONF"."SP_NMLSTNOMA" (ws_nom_rep IN VARCHAR2,ws_des_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,wn_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2,wn_key_pro IN NUMBER,wn_tip_nom IN NUMBER,ws_key_per IN VARCHAR2 ) IS
