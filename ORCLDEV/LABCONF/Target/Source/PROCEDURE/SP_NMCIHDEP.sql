CREATE OR REPLACE EDITIONABLE PROCEDURE "LABCONF"."SP_NMCIHDEP" (ws_nom_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,ws_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2,ws_lis_per IN VARCHAR2,ws_dep_pri IN VARCHAR2,ws_key_est IN VARCHAR2 ) IS
