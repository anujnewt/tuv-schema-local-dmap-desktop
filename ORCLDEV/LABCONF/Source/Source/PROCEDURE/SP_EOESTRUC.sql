CREATE OR REPLACE EDITIONABLE PROCEDURE "LABCONF"."SP_EOESTRUC" (ws_nvo_nom IN VARCHAR2,ws_nom_ant IN VARCHAR2,ws_sub_mov IN VARCHAR2,wf_fec_mov IN  DATE,ws_est_ant IN VARCHAR2,ws_est_act IN VARCHAR2,ws_est_ope IN VARCHAR2 ) IS
