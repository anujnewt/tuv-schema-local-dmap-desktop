CREATE OR REPLACE EDITIONABLE PROCEDURE "LABCONF"."SP_NMLSTMO4" (ws_nom_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,wn_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2,wn_key_pro IN NUMBER,ws_key_per IN VARCHAR2,wn_tip_rep IN NUMBER,ws_nom_rp1 IN VARCHAR2 ) IS
