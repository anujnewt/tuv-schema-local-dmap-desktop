CREATE OR REPLACE EDITIONABLE PROCEDURE "LABCONF"."SP_NMACTACU" (ws_nom_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,wn_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2,wn_key_pro IN  NUMBER,ws_acu_uno IN VARCHAR2,ws_acu_dos IN VARCHAR2,ws_acu_tre IN VARCHAR2,ws_acu_cua IN VARCHAR2,ws_acu_cin IN VARCHAR2,ws_acu_sei IN VARCHAR2,ws_acu_sie IN VARCHAR2,ws_acu_och IN VARCHAR2,ws_acu_nue IN VARCHAR2,ws_acu_die IN VARCHAR2,ws_acu_onc IN VARCHAR2,ws_acu_doc IN VARCHAR2,ws_acu_trc IN VARCHAR2,ws_per_ini IN VARCHAR2,ws_per_fin IN VARCHAR2,ws_cod_acu IN VARCHAR2,wn_che_eli IN  NUMBER ) IS
