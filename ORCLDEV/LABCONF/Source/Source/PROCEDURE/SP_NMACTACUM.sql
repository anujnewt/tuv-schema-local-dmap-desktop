CREATE OR REPLACE EDITIONABLE PROCEDURE "LABCONF"."SP_NMACTACUM" (ws_nom_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,wn_key_usu IN NUMBER,wn_key_pro IN NUMBER,wn_num_mes IN NUMBER,ws_cod_acu IN VARCHAR2,wn_ani_oac IN NUMBER ) IS
