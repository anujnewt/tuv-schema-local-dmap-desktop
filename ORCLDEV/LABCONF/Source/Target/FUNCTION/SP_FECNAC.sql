create or replace  function  labconf."sp_fecnac"  (vn_regrfc varchar) returns timestamp(0) as $body$
declare
...
vd_fecnac :=  concat(mes, '/', dia, '/19', anio) ;/* dmap converted statement end */
else
