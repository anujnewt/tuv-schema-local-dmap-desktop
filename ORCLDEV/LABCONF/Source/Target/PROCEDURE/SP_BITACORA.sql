create or replace procedure labconf."sp_bitacora"  (wn_key_usu numeric, ws_log_usu varchar, ws_ide_pcc varchar, ws_tip_mov varchar, ws_key_001 varchar, ws_key_002 varchar, ws_key_003 varchar, ws_val_001 varchar, ws_val_002 varchar, ws_val_003 varchar, ws_des_men varchar) as $body$
declare
