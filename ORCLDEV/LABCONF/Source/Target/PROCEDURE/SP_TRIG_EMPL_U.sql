...
call sp_bitacora (9999, 'Trigger', 'SIHO_ORAC', 'CA', 'emp_keyemp','emp_keypro','',new_keyemp,new_keypro,'','Maestro de Empleados');
-- grabamos detalle de la bitacora
call sp_detbitac (9999, 'SIHO_ORAC', 'nmcoempl', 'emp_recurp', old_recurp,new_recurp);
end if;end;
$body$
language plpgsql
;
