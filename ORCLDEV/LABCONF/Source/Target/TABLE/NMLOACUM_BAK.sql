-- dmap_object_gen_tag : type : table name : nmloacum_bak
set search_path = labconf,oracle,dmap_extension,public;
create table "nmloacum_bak"  (
...
-- dmap_object_gen_tag : type : alter table name : nmloacum_bak
set search_path = labconf,oracle,dmap_extension,public;
alter table nmloacum_bak alter column acu_keyemp set not null;
-- dmap_object_gen_tag : type : alter table name : nmloacum_bak
set search_path = labconf,oracle,dmap_extension,public;
alter table nmloacum_bak alter column acu_keycon set not null;
