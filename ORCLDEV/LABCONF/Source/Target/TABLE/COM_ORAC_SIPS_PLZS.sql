-- dmap_object_gen_tag : type : table name : com_orac_sips_plzs
set search_path = labconf,oracle,dmap_extension,public;
create table "com_orac_sips_plzs"  (
...
-- dmap_object_gen_tag : type : alter table name : com_orac_sips_plzs
set search_path = labconf,oracle,dmap_extension,public;
alter table com_orac_sips_plzs alter column ora_noctvo set not null;
