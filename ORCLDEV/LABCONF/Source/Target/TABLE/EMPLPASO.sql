-- dmap_object_gen_tag : type : table name : emplpaso
set search_path = labconf,oracle,dmap_extension,public;
create table "emplpaso"  (
...
-- dmap_object_gen_tag : type : alter table name : emplpaso
set search_path = labconf,oracle,dmap_extension,public;
alter table emplpaso alter column ora_noctvo set not null;
