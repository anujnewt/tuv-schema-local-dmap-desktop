create or replace  function  labconf.calculoisn_importeisn (ws_key_ent varchar,wn_base numeric, wn_por_cen numeric,wn_por_adi numeric, ws_key_tab varchar,wn_cuo_fij numeric, wn_tot_emp numeric) returns numeric as $body$
declare
...
wn_imp_adi := labconf.calculoisn_importeadi(ws_key_ent,wn_base, wn_por_cen, wn_por_adi, ws_key_tab, wn_imp_isn);
