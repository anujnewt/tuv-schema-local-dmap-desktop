...
--dmap moved type current package tvcontab;
dr_concep labconf.nmlohism.his_keycon%type;
--dmap moved type current package tvcontab;
...
into strict nomina,cvepoliza,cveversionproc
...
if total = 0 then
update labconf.nmloperi set per_persel = null where per_keyper = periodo and per_keypro = proceso;
...
call tvcontab_sp_reclasifica(proceso,periodo,cvepoliza);
