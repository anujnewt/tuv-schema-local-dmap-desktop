create or replace  function  labconf.utils_convert_to_clob_ (p_expr ts , p_precision numeric default 0, p_scale numeric default 0, p_style numeric default null) returns text as $body$
declare
