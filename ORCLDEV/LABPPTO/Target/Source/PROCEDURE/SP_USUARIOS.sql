CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABPPTO"."SP_USUARIOS" 
					(wn_key_usu IN NUMBER, 		ws_nom_usu IN VARCHAR2,
...
-- PGV moved types start
-- PGV moved types end
    ws_fec_mov DATE := LABPPTO.sp_glgetfec;
    ws_hor_mov VARCHAR2(5) := SUBSTR (LABPPTO.sp_glgethor, 1, 5);
BEGIN
	INSERT INTO LABPPTO.glcousua
	...
	EXCEPTION
    WHEN OTHERS THEN
        LABPPTO.sp_glgenerr ('USUARIOS', 'ID DE PC', 0, LABPPTO.sp_glgethor, SQLCODE, 0, SUBSTR (SQLERRM, 1, 60));
END;
/
