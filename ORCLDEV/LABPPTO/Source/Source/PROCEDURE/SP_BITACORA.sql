CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABPPTO"."SP_BITACORA" (wn_key_usu IN NUMBER, ws_log_usu IN VARCHAR2,
...
BEGIN
    ...
    INSERT INTO LABPPTO.glwkcrys
              (cry_nomrep, cry_idepcc, cry_keyusu, cry_dat001, cry_chr012)
      VALUES  (ws_ide_bit, ws_ide_pcc, wn_key_usu, SYSDATE, ws_hor_mov);
    INSERT INTO LABPPTO.glcobita
      ...
      VALUES (wn_key_usu, ws_log_usu, ws_ide_pcc, SYSDATE, ws_hor_mov,
