CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "USRDRC"."DERCORP_APODERADOS_NAMES_VW" ("ID_EMPRESA", "NOM_EMPRESA", "DES_ESCRITURA", "NUM_TIPO_PODER", "TIPO_PODER", "DES_GRUPO", "ID_CATALOGO", "ID_CATALOGO_VALOR", "VAL_CAT_VAL", "DES_TIPO_BAJA", "DES_DOCUMENTO", "FEC_FECHA_BAJA") AS 
  SELECT
  EMP.ID_EMPRESA,
  EMP.NOM_EMPRESA,
