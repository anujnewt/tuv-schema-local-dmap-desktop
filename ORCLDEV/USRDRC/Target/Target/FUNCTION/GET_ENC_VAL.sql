create or replace  function  usrdrc."get_enc_val"  ( p_in_val varchar, p_key varchar default '1234567890123456', p_algorithm varchar default 'AES128', p_iv varchar default null) returns varchar as $body$
declare
