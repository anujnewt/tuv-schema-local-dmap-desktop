-- dmap_object_gen_tag : type : table name : dercorp_reportflex_params_tab
set search_path = usrdrc,oracle,dmap_extension,public;
create table "dercorp_reportflex_params_tab"  (
id_reportflex numeric not null,
id_param varchar(250) not null,
...
-- dmap_object_gen_tag : type : alter table name : dercorp_reportflex_params_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table dercorp_reportflex_params_tab add primary key (id_reportflex,id_param);
