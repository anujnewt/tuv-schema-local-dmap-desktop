-- dmap_object_gen_tag : type : table name : dercorp_rol_seccion_tab
set search_path = usrdrc,oracle,dmap_extension,public;
create table "dercorp_rol_seccion_tab"  (
...
-- dmap_object_gen_tag : type : alter table name : dercorp_rol_seccion_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table dercorp_rol_seccion_tab add constraint dercorp_rol_seccion_tab_pk primary key (id_rol,id_seccion);
-- dmap_object_gen_tag : type : alter table name : dercorp_rol_seccion_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table dercorp_rol_seccion_tab alter column id_rol set not null;
-- dmap_object_gen_tag : type : alter table name : dercorp_rol_seccion_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table dercorp_rol_seccion_tab alter column id_seccion set not null;
