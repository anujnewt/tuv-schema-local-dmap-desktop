-- dmap_object_gen_tag : type : table name : dercorp_add_campo_cat_tab
set search_path = usrdrc,oracle,dmap_extension,public;
create table "dercorp_add_campo_cat_tab"  (
id_catalogo numeric,
...
-- dmap_object_gen_tag : type : alter table name : dercorp_add_campo_cat_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table dercorp_add_campo_cat_tab add constraint dercorp_add_campo_cat_tab_uk1 unique (nom_catalogo);
-- dmap_object_gen_tag : type : alter table name : dercorp_add_campo_cat_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table dercorp_add_campo_cat_tab alter column nom_catalogo set not null;
