-- dmap_object_gen_tag : type : table name : dercorp_flex_columns_catgo_tab
set search_path = usrdrc,oracle,dmap_extension,public;
create table "dercorp_flex_columns_catgo_tab"  (
...
-- dmap_object_gen_tag : type : alter table name : dercorp_flex_columns_catgo_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table dercorp_flex_columns_catgo_tab alter column id_catalogo set not null;
