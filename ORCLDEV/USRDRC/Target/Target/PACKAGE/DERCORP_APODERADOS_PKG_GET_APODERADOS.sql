create or replace  function  usrdrc.dercorp_apoderados_pkg_get_apoderados (pinidempresa numeric, pintipopoder numeric, pstescritura varchar, pstgrupo varchar, pstatributo3 varchar) returns varchar as $body$
declare
...
loop
lstapoderados :=  concat(lstapoderados, '</br><LI>', i.apoderado) ;/* dmap converted statement end */
