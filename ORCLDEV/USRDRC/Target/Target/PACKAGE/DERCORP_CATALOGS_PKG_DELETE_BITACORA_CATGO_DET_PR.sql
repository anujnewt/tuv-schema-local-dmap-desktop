create or replace procedure usrdrc.dercorp_catalogs_pkg_delete_bitacora_catgo_det_pr ( pstnomcatalogo varchar, pstnomdetcatalogo varchar, pistusuario varchar) as $body$
declare
