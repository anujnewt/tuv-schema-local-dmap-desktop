create or replace  function  usrdrc.dercorp_wk_apoderados_pkg_get_dominio (pinidempresa numeric, pintipopoder numeric, pstescritura varchar, pstgrupo varchar) returns varchar as $body$
declare
