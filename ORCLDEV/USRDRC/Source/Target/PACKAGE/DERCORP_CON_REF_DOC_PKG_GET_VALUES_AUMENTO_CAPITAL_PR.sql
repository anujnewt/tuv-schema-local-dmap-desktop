create or replace procedure usrdrc.dercorp_con_ref_doc_pkg_get_values_aumento_capital_pr (porcrsaumentocapital inout refcursor ,piinidmetarow numeric ) as $body$
declare
