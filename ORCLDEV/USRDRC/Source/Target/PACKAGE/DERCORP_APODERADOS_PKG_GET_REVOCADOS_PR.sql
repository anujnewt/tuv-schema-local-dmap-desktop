create or replace procedure usrdrc.dercorp_apoderados_pkg_get_revocados_pr ( pinidempresa numeric, pintipopoder numeric, pstescritura varchar, pstleyenda inout varchar --,pstgrupo     varchar2
) as $body$
declare
