create or replace  function  usrdrc.dercorp_apoderados_pkg_get_grupo_union_revocado_snum ( pinidempresa numeric, pintipopoder numeric, pstescritura varchar, pstgrupo varchar) returns varchar as $body$
declare
