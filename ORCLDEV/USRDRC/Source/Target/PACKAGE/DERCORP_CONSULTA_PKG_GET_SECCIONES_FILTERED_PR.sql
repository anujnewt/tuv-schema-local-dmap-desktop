create or replace procedure usrdrc.dercorp_consulta_pkg_get_secciones_filtered_pr (piinrolid numeric,resultset inout refcursor, sectionid varchar) as $body$
declare
