create or replace procedure usrdrc.dercorp_con_ref_doc_pkg_get_values_sesion_consejo_pr (porcrssesionconsejo inout refcursor ,piinidmetarow numeric ) as $body$
declare
