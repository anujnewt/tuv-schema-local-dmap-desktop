create or replace procedure usrdrc.dercorp_consulta_pkg_get_agrupaciones_con_flex_pr (sectionid numeric, subsectionid numeric, resultset inout refcursor, piinidemp numeric) as $body$
declare
