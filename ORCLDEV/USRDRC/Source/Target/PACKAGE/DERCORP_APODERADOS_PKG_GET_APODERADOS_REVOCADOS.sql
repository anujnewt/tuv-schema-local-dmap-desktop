create or replace  function  usrdrc.dercorp_apoderados_pkg_get_apoderados_revocados (pinidempresa numeric, pintipopoder numeric, pstescritura varchar, pstgrupo varchar, pstatributo3 varchar) returns varchar as $body$
declare
-- pgv moved types start
-- pgv moved types end
lstapoderados varchar(3000);
i record;
begin
...
lstapoderados :=  concat('<b>', pstatributo3, '</b><br><!-- X1 -->') ;  -- nava 23/feb/2016 - para quitar la sangria
