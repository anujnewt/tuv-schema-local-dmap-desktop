create or replace  function  usrdrc.dercorp_reportflex_pkg_get_entidad_value (idaddcampo integer, idempresa integer) returns varchar as $body$
declare
...
select
--cv.id_add_campo,
coalesce(cat.atributo2,cv.val_valor) into strict val
from
