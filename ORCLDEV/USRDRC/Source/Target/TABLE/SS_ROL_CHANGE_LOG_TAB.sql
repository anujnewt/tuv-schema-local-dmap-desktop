-- dmap_object_gen_tag : type : table name : ss_rol_change_log_tab
set search_path = usrdrc,oracle,dmap_extension,public;
create table "ss_rol_change_log_tab"  (
id_rol_change_log numeric not null,
id_user numeric,
id_rol numeric,
nom_rol varchar(250),
...
-- dmap_object_gen_tag : type : alter table name : ss_rol_change_log_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table ss_rol_change_log_tab add constraint ss_rol_change_log_pk primary key (id_rol_change_log);
-- dmap_object_gen_tag : type : alter table name : ss_rol_change_log_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table ss_rol_change_log_tab alter column id_rol_change_log set not null;
