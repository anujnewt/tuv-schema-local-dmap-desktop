-- dmap_object_gen_tag : type : table name : dercorp_empresa_tab
set search_path = usrdrc,oracle,dmap_extension,public;
create table "dercorp_empresa_tab"  (
...
-- dmap_object_gen_tag : type : alter table name : dercorp_empresa_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table dercorp_empresa_tab add constraint dercorp_empresa_tab_pk primary key (id_empresa);
-- dmap_object_gen_tag : type : alter table name : dercorp_empresa_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table dercorp_empresa_tab alter column id_empresa set not null;
