-- dmap_object_gen_tag : type : table name : ss_user_rol_tab
set search_path = usrdrc,oracle,dmap_extension,public;
create table "ss_user_rol_tab"  (
...
-- dmap_object_gen_tag : type : alter table name : ss_user_rol_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table ss_user_rol_tab add constraint ss_user_rol_pk primary key (id_user,id_rol);
-- dmap_object_gen_tag : type : alter table name : ss_user_rol_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table ss_user_rol_tab alter column id_user set not null;
-- dmap_object_gen_tag : type : alter table name : ss_user_rol_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table ss_user_rol_tab alter column id_rol set not null;
