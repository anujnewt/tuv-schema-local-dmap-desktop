-- dmap_object_gen_tag : type : table name : dercorp_no_camp_gpoemp_tab
set search_path = usrdrc,oracle,dmap_extension,public;
create table "dercorp_no_camp_gpoemp_tab"  (
...
-- dmap_object_gen_tag : type : alter table name : dercorp_no_camp_gpoemp_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table dercorp_no_camp_gpoemp_tab alter column id_add_campo set not null;
-- dmap_object_gen_tag : type : alter table name : dercorp_no_camp_gpoemp_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table dercorp_no_camp_gpoemp_tab alter column id_gpo_empresa set not null;
