-- dmap_object_gen_tag : type : table name : pendium_ss_log_stat_conect_tab
set search_path = usrdrc,oracle,dmap_extension,public;
create table "pendium_ss_log_stat_conect_tab"  (
id_log numeric,
...
-- dmap_object_gen_tag : type : alter table name : pendium_ss_log_stat_conect_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table pendium_ss_log_stat_conect_tab alter column id_user set not null;
-- dmap_object_gen_tag : type : alter table name : pendium_ss_log_stat_conect_tab
set search_path = usrdrc,oracle,dmap_extension,public;
alter table pendium_ss_log_stat_conect_tab alter column fec_log set not null;
