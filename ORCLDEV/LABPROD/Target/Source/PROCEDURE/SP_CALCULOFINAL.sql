CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABPROD"."SP_CALCULOFINAL" (wn_key_pro IN NUMBER, ws_key_per IN varchar, ws_nom_rep IN varchar, ws_fec_ini IN varchar, ws_hor_ini IN varchar)
AS
