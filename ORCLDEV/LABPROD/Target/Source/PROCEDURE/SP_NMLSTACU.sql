CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABPROD"."SP_NMLSTACU" (ws_nom_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,wn_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2, wn_ani_oac IN NUMBER ) IS
...
-- PGV moved types end
	...
	INTO wn_tot_reg FROM LABPROD.nmloacum
	WHERE acu_keypro IN (
...
EXCEPTION
 WHEN NO_DATA_FOUND THEN
  ...
  LABPROD.sp_glfechor(wd_fec_act, ws_hor_act);
	...
	INTO ws_des_cor FROM LABPROD.glcocorp;
EXCEPTION
 WHEN NO_DATA_FOUND THEN
  NULL;
  END;
...
EXCEPTION
 WHEN NO_DATA_FOUND THEN
  ...
  ws_etq_001:='Empleado';
	...
	wn_dsp_031:=0;
	wn_dsp_032:=0;
	LABPROD.sp_glnewdsp('nmloacum',  'acu_keyemp' , ws_key_men,wn_dsp_001);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_keycon' , ws_key_men,wn_dsp_002);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_uniuno' , ws_key_men,wn_dsp_003);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unidos' , ws_key_men,wn_dsp_004);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unitre' , ws_key_men,wn_dsp_005);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unicua' , ws_key_men,wn_dsp_006);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unicin' , ws_key_men,wn_dsp_007);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unisei' , ws_key_men,wn_dsp_008);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unisie' , ws_key_men,wn_dsp_009);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unioch' , ws_key_men,wn_dsp_010);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_uninue' , ws_key_men,wn_dsp_011);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unidie' , ws_key_men,wn_dsp_012);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unionc' , ws_key_men,wn_dsp_013);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unidoc' , ws_key_men,wn_dsp_014);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unitre' , ws_key_men,wn_dsp_015);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unicua' , ws_key_men,wn_dsp_016);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_unicat' , ws_key_men,wn_dsp_017);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_uniqui' , ws_key_men,wn_dsp_018);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_impuno' , ws_key_men,wn_dsp_019);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_impdos' , ws_key_men,wn_dsp_020);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_imptre' , ws_key_men,wn_dsp_021);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_impcua' , ws_key_men,wn_dsp_022);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_impcin' , ws_key_men,wn_dsp_023);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_impsei' , ws_key_men,wn_dsp_024);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_impoch' , ws_key_men,wn_dsp_025);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_impnue' , ws_key_men,wn_dsp_026);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_impdie' , ws_key_men,wn_dsp_027);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_imponc' , ws_key_men,wn_dsp_028);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_impdoc' , ws_key_men,wn_dsp_029);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_imptre' , ws_key_men,wn_dsp_030);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_impcat' , ws_key_men,wn_dsp_031);
	LABPROD.sp_glnewdsp('nmloacum',  'acu_impqui' , ws_key_men,wn_dsp_032);
	ws_con_ant:='@@@';
...
EXCEPTION
 WHEN NO_DATA_FOUND THEN
  ...
  BEGIN SELECT cia_descia
	INTO ws_des_cor FROM LABPROD.nmloproc, LABPROD.nmlocias
	WHERE pro_keypro = wn_key_pro
