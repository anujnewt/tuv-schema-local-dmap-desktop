CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABPROD"."SP_NMINEM01" (ws_nom_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,wn_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2,ws_nom_ran IN VARCHAR2 ) IS
...
-- PGV moved types end
	...
	INTO wn_tot_reg FROM LABPROD.nmcoinci
	WHERE inc_keyinc IN (
...
EXCEPTION
 WHEN NO_DATA_FOUND THEN
  ...
  ws_des_lis:='Reporte de Incidencias';
	...
	wn_dsp_008:=0;
	wn_dsp_009:=0;
	LABPROD.sp_glnewdsp('nmcoinci', 'inc_keypro', ws_key_men,wn_dsp_001);
	LABPROD.sp_glnewdsp('nmcoinci', 'inc_keyper', ws_key_men,wn_dsp_002);
	LABPROD.sp_glnewdsp('nmcoinci', 'inc_keyemp', ws_key_men,wn_dsp_003);
	LABPROD.sp_glnewdsp('nmcoinci', 'inc_keycon', ws_key_men,wn_dsp_004);
	LABPROD.sp_glnewdsp('nmcoinci', 'inc_cantid', ws_key_men,wn_dsp_005);
	LABPROD.sp_glnewdsp('nmcoinci', 'inc_import', ws_key_men,wn_dsp_006);
	LABPROD.sp_glnewdsp('nmcoinci', 'inc_fecmov', ws_key_men,wn_dsp_007);
	LABPROD.sp_glnewdsp('nmcoinci', 'inc_keydep', ws_key_men,wn_dsp_008);
	LABPROD.sp_glnewdsp('nmcoinci', 'inc_keypue', ws_key_men,wn_dsp_009);
	wn_ant_emp:=-0000;
	ws_ant_con:='@@@';
	wn_ant_pro:=-0000;
	ws_ant_dep:=0;
