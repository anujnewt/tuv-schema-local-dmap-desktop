CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABPROD"."SP_NMLSTNM1A" (ws_nom_rep IN VARCHAR2,ws_des_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,wn_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2,wn_key_pro IN NUMBER,wn_tip_nom IN NUMBER ) IS
...
EXCEPTION
 WHEN NO_DATA_FOUND THEN
  ...
  ws_etq_001:='........';
	...
	LABPROD.sp_glnewdsp('nmlohism', 'his_keydep', ws_key_men,wn_dsp_002);
	LABPROD.sp_glnewdsp('nmlohism', 'his_keypue', ws_key_men,wn_dsp_003);
	LABPROD.sp_glnewdsp('nmlohism', 'his_keycon', ws_key_men,wn_dsp_004);
	LABPROD.sp_glnewdsp('nmlohism', 'his_keyper', ws_key_men,wn_dsp_005);
	LABPROD.sp_glnewdsp('nmlohism', 'his_keynom', ws_key_men,wn_dsp_006);
	LABPROD.sp_glnewdsp('nmlohism', 'his_cantid', ws_key_men,wn_dsp_007);
	LABPROD.sp_glnewdsp('nmlohism', 'his_import', ws_key_men,wn_dsp_008);
	LABPROD.sp_glnewdsp('nmlohism', 'emp_tipemp', ws_key_men,wn_dsp_009);
	LABPROD.sp_glnewdsp('nmlohism', 'emp_keyloc', ws_key_men,wn_dsp_010);
	wn_num_reg:=0;
	wn_pct_act:=1;
...
EXCEPTION
 WHEN NO_DATA_FOUND THEN
  ...
  ws_des_li1:='No existe nombre del Reporte';
	...
	INTO ws_des_li1 FROM LABPROD.glcolist
...
EXCEPTION
 WHEN NO_DATA_FOUND THEN
  ...
  ws_des_lis:= SUBSTR(ws_des_li1,1,40);
	...
	INTO ws_nom_emp, ws_reg_rfc, wn_sal_dia, wn_sal_int, ws_key_dep, ws_key_pue, ws_tip_emp, ws_key_ims, ws_key_loc, ws_reg_ims FROM LABPROD.nmcoempl
...
EXCEPTION
 WHEN NO_DATA_FOUND THEN
  ...
  END;
	...
	INTO ws_dep_his, ws_pue_his, ws_loc_his FROM LABPROD.nmlohism
