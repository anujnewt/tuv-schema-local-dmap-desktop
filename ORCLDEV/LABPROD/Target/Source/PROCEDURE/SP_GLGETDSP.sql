CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABPROD"."SP_GLGETDSP" (ws_key_tab IN VARCHAR2,ws_key_cam IN VARCHAR2,ws_key_men IN VARCHAR2,wn_val_dsp OUT NUMBER ) IS
