CREATE TABLE "LABPROD"."XXAP_TIMB_VIATICOS_CTRL_LAB" 
...
ALTER TABLE "LABPROD"."XXAP_TIMB_VIATICOS_CTRL_LAB" ADD CONSTRAINT "PK_ID_TIMBRADO_VIATICOS" PRIMARY KEY ("ID_TIMBRADO_VIATICOS")
  USING INDEX  ENABLE;
