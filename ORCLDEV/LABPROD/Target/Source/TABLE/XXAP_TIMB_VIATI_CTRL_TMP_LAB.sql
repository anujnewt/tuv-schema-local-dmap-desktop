CREATE TABLE "LABPROD"."XXAP_TIMB_VIATI_CTRL_TMP_LAB" 
...
ALTER TABLE "LABPROD"."XXAP_TIMB_VIATI_CTRL_TMP_LAB" ADD CONSTRAINT "PK_ID_TIMBRADO_VIATICOS_TMP" PRIMARY KEY ("ID_TIMBRADO_VIATICOS")
  USING INDEX  ENABLE;
