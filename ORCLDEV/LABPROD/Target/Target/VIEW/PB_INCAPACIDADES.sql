...
from labprod.tvpbincc
inner join labprod.nmcoempl on inc_keyemp = emp_keyemp
inner join labprod.nmloproc on pro_keypro = emp_keypro
where     inc_diainc >= 30;/* dmap converted statement end */
