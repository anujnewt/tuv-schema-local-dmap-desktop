...
create or replace view "pb_movimientos"  ("fecha_captura", "emp_keyemp", "nombre", "fecha_movimiento", "tipo_movimiento", "plz_act", "plz_ant", "dpto_act", "dpto_ant", "pto_act", "pto_ant", "submovimiento") as select tra_fecmod fecha_captura,
...
pto_ant,
labprod.nmlotray.tra_submov submovimiento
from labprod.nmlotray
inner join labprod.nmcoempl on tra_keyemp = emp_keyemp
where tra_tipmov in ('8', '9', '10');/* dmap converted statement end */
