create or replace procedure labprod.tvcdesaf_local_validacion (recurp labprod.nmcoempl.emp_recurp%type, keycon labprod.nmloconc.con_keycon%type, resultado inout numeric, emp inout tvcdesaf_local_empleado, per inout tvcdesaf_local_periodo) as $body$
declare
