create or replace  function  labprod.utils_get_format_from_style (p_style numeric) returns varchar as $body$
declare
...
if dmap_extension.f_dmap_get_pkg_var('LABPROD' , 'UTILS', 'DATABASE_TYPE', 'VARCHAR2', 'Y')::varchar = dmap_extension.f_dmap_get_pkg_var('LABPROD' , 'UTILS', 'SQLSERVER', 'VARCHAR2', 'Y')::varchar then
v_format := case
