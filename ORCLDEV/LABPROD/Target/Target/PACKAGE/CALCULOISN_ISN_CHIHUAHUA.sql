create or replace  function  labprod.calculoisn_isn_chihuahua (wn_base numeric,wn_por_cen numeric, wn_por_adi numeric, ws_key_tab varchar, wn_tot_emp numeric) returns numeric as $body$
declare
