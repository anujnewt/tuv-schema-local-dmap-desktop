create or replace procedure labprod.interfacerecibos_insertarestatusrecibo (idcomprobanteemp numeric, status numeric, errorstr varchar) as $body$
declare
...
on (labprod.cfdi2estatusrecibos.idcomprobanteemp = insertarestatusrecibo.idcomprobanteemp)
when matched then
