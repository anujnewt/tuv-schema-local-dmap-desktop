...
-- dmap_object_gen_tag : type : alter table name : eocoplza
set search_path = labprod,oracle,dmap_extension,public;
alter table eocoplza add constraint eoplza01 unique (plz_keyplz);
-- dmap_object_gen_tag : type : alter table name : eocoplza
set search_path = labprod,oracle,dmap_extension,public;
alter table eocoplza alter column plz_keyplz set not null;
-- dmap_object_gen_tag : type : alter table name : eocoplza
set search_path = labprod,oracle,dmap_extension,public;
alter table eocoplza alter column plz_keysol set not null;
-- dmap_object_gen_tag : type : alter table name : eocoplza
set search_path = labprod,oracle,dmap_extension,public;
alter table eocoplza alter column plz_keypro set not null;
-- dmap_object_gen_tag : type : alter table name : eocoplza
set search_path = labprod,oracle,dmap_extension,public;
alter table eocoplza alter column plz_keyest set not null;
-- dmap_object_gen_tag : type : alter table name : eocoplza
set search_path = labprod,oracle,dmap_extension,public;
alter table eocoplza alter column plz_keydep set not null;
-- dmap_object_gen_tag : type : alter table name : eocoplza
set search_path = labprod,oracle,dmap_extension,public;
alter table eocoplza alter column plz_keypue set not null;
