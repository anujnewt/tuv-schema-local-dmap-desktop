create or replace procedure labprod."sp_nmlstctt"  (ws_nom_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar ) as $body$
declare
-- pgv moved types start
-- pgv moved types end
ws_pam_key varchar(6);
ws_pam_cve varchar(6);
-- ws_pam_nom varchar(50);
ws_pam_nom varchar(200);
...
ws_tab_ant varchar(6);
ws_des_lis varchar(50);
ws_key_cam varchar(10);
ws_des_etq varchar(10);
ws_etq_001 varchar(200);
ws_etq_002 varchar(200);
ws_etq_003 varchar(200);
ws_etq_004 varchar(200);
ws_etq_005 varchar(200);
ws_etq_006 varchar(200);
ws_etq_007 varchar(200);
...
begin
select  count(*) alias1
into strict wn_tot_reg from labprod.glcopams
where pam_keypar in (
...
wn_dsp_004:=0;
wn_dsp_005:=0;
call labprod.sp_glnewdsp ('glcopams', 'pam_keypar', ws_key_men,wn_dsp_001);
call labprod.sp_glnewdsp ('glcopams', 'pam_cvesec', ws_key_men,wn_dsp_002);
call labprod.sp_glnewdsp ('glcopams', 'pam_nompar', ws_key_men,wn_dsp_003);
call labprod.sp_glnewdsp ('glcopams', 'pam_folini', ws_key_men,wn_dsp_004);
call labprod.sp_glnewdsp ('glcopams', 'pam_folfin', ws_key_men,wn_dsp_005);
ws_tab_ant:='______';
wn_num_reg:=0;
wn_pct_act:=1;
...
select pam_nompar
into strict ws_etq_007 from labprod.glcopams
