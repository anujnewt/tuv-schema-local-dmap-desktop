create or replace procedure labprod."sp_tvfacfin1"  (wn_keypro numeric , ws_keyper varchar, wn_keynom numeric, wn_keycia numeric, ws_tippol varchar, ws_tiprep varchar, ws_opcrep varchar, ws_lote varchar, wd_fecpol timestamp(0), ws_nomrep varchar, ws_idepcc varchar, wn_keyusu numeric) as $body$
declare
