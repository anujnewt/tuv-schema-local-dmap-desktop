create or replace procedure labprod."sp_nmlstacu"  (ws_nom_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar, wn_ani_oac numeric ) as $body$
declare
...
into strict wn_tot_reg from labprod.nmloacum
where acu_keypro in (
...
wn_dsp_031:=0;
wn_dsp_032:=0;
call labprod.sp_glnewdsp ('nmloacum',  'acu_keyemp' , ws_key_men,wn_dsp_001);
call labprod.sp_glnewdsp ('nmloacum',  'acu_keycon' , ws_key_men,wn_dsp_002);
call labprod.sp_glnewdsp ('nmloacum',  'acu_uniuno' , ws_key_men,wn_dsp_003);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unidos' , ws_key_men,wn_dsp_004);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unitre' , ws_key_men,wn_dsp_005);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unicua' , ws_key_men,wn_dsp_006);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unicin' , ws_key_men,wn_dsp_007);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unisei' , ws_key_men,wn_dsp_008);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unisie' , ws_key_men,wn_dsp_009);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unioch' , ws_key_men,wn_dsp_010);
call labprod.sp_glnewdsp ('nmloacum',  'acu_uninue' , ws_key_men,wn_dsp_011);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unidie' , ws_key_men,wn_dsp_012);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unionc' , ws_key_men,wn_dsp_013);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unidoc' , ws_key_men,wn_dsp_014);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unitre' , ws_key_men,wn_dsp_015);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unicua' , ws_key_men,wn_dsp_016);
call labprod.sp_glnewdsp ('nmloacum',  'acu_unicat' , ws_key_men,wn_dsp_017);
call labprod.sp_glnewdsp ('nmloacum',  'acu_uniqui' , ws_key_men,wn_dsp_018);
call labprod.sp_glnewdsp ('nmloacum',  'acu_impuno' , ws_key_men,wn_dsp_019);
call labprod.sp_glnewdsp ('nmloacum',  'acu_impdos' , ws_key_men,wn_dsp_020);
call labprod.sp_glnewdsp ('nmloacum',  'acu_imptre' , ws_key_men,wn_dsp_021);
call labprod.sp_glnewdsp ('nmloacum',  'acu_impcua' , ws_key_men,wn_dsp_022);
call labprod.sp_glnewdsp ('nmloacum',  'acu_impcin' , ws_key_men,wn_dsp_023);
call labprod.sp_glnewdsp ('nmloacum',  'acu_impsei' , ws_key_men,wn_dsp_024);
call labprod.sp_glnewdsp ('nmloacum',  'acu_impoch' , ws_key_men,wn_dsp_025);
call labprod.sp_glnewdsp ('nmloacum',  'acu_impnue' , ws_key_men,wn_dsp_026);
call labprod.sp_glnewdsp ('nmloacum',  'acu_impdie' , ws_key_men,wn_dsp_027);
call labprod.sp_glnewdsp ('nmloacum',  'acu_imponc' , ws_key_men,wn_dsp_028);
call labprod.sp_glnewdsp ('nmloacum',  'acu_impdoc' , ws_key_men,wn_dsp_029);
call labprod.sp_glnewdsp ('nmloacum',  'acu_imptre' , ws_key_men,wn_dsp_030);
call labprod.sp_glnewdsp ('nmloacum',  'acu_impcat' , ws_key_men,wn_dsp_031);
call labprod.sp_glnewdsp ('nmloacum',  'acu_impqui' , ws_key_men,wn_dsp_032);
ws_con_ant:='______';
...
from labprod.nmloacum, labprod.glwkrang
where ran_nomrep = ws_nom_rep
and ran_idepcc = ws_ide_pcc
and ran_keyusu = wn_key_usu
...
into strict ws_des_pro from labprod.nmloproc
...
into strict ws_des_cor from labprod.nmloproc, labprod.nmlocias
where pro_keypro = wn_key_pro
...
into strict ws_nom_emp from labprod.nmcoempl
...
insert into labprod.glwkcrys( cry_nomrep,cry_idepcc,cry_keyusu,cry_chr001,cry_dec013,cry_chr012,cry_chr003,cry_chr002,cry_dec001,cry_dec002,cry_dec003,cry_dec004,cry_dec005,cry_dec011,cry_dec012,cry_chr004,cry_dec014,cry_dec015,cry_chr005,cry_chr006,cry_chr007,cry_dec025,cry_chr009,cry_chr010,cry_chr011,cry_dec024,cry_chr013,cry_chr014,cry_chr015,cry_chr016,cry_dec016,cry_dec017,cry_dec018,cry_dec019,cry_dec020,cry_dec021,cry_dec022,cry_dec023,cry_chr017,cry_chr018,cry_chr019,cry_chr020,cry_chr021,cry_chr036,cry_dat001,cry_dec006,cry_chr008,cry_dec007)
