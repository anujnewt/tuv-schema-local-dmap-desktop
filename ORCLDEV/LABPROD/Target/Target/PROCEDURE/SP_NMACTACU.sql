create or replace procedure labprod."sp_nmactacu"  (ws_nom_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar,wn_key_pro numeric,ws_acu_uno varchar,ws_acu_dos varchar,ws_acu_tre varchar,ws_acu_cua varchar,ws_acu_cin varchar,ws_acu_sei varchar,ws_acu_sie varchar,ws_acu_och varchar,ws_acu_nue varchar,ws_acu_die varchar,ws_acu_onc varchar,ws_acu_doc varchar,ws_acu_trc varchar,ws_per_ini varchar,ws_per_fin varchar,ws_cod_acu varchar,wn_che_eli numeric, wn_ani_oac numeric ) as $body$
declare
