create or replace procedure labprod."sp_nmactacum"  (ws_nom_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,wn_key_pro numeric,wn_num_mes numeric,ws_cod_acu varchar,wn_ani_oac numeric ) as $body$
declare
