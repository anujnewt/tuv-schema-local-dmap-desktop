create or replace procedure labprod."sp_nmhismov"  (ws_nom_rep varchar, ws_ide_pcc varchar, wn_key_usu numeric, ws_key_men varchar, ws_hor_reg varchar, ws_etq_rep varchar) as $body$
declare
...
begin
-- variables para las restricciones de despliegue.
call labprod.sp_glgetdsp ('nmlohism', 'his_keyemp', ws_key_men,wn_dsp_001);
call labprod.sp_glgetdsp ('nmlohism', 'his_keycon', ws_key_men,wn_dsp_002);
call labprod.sp_glgetdsp ('nmlohism', 'his_cantid', ws_key_men,wn_dsp_003);
call labprod.sp_glgetdsp ('nmlohism', 'his_import', ws_key_men,wn_dsp_004);
call labprod.sp_glgetdsp ('nmlohism', 'his_keyper', ws_key_men,wn_dsp_005);
...
insert into labprod.glwkcrys(cry_nomrep, cry_idepcc, cry_keyusu, cry_numsec, cry_chr001,
...
j := j + 1;
if j > i then
insert into labprod.glwkcrys(cry_nomrep, cry_idepcc, cry_keyusu, cry_numsec, cry_chr001, cry_chr017,
