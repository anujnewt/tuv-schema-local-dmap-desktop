create or replace procedure labprod."sp_nmincem1"  ( wn_key_pro numeric, ws_key_per varchar, ws_key_men varchar, ws_des_pro inout varchar, ws_des_nom inout varchar, ws_per_ant inout varchar, wd_fec_ini inout timestamp(0), wd_fec_fin inout timestamp(0), wn_key_nom inout numeric ) as $body$
declare
