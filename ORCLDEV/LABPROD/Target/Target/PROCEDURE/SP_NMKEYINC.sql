create or replace procedure labprod."sp_nmkeyinc"  ( wn_sem_ila numeric, ws_key_con varchar, wn_key_pro numeric, wn_key_nom numeric, ws_key_per varchar, wn_key_emp numeric, wn_num_sec numeric, wn_key_inc inout numeric) as $body$
declare
