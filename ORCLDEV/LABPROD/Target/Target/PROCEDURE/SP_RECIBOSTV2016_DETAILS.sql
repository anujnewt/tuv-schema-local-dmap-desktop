create or replace procedure labprod."sp_recibostv2016_details"  ( v_keybin varchar default 'nmgrec', --v_action in varchar2 default 'DETAILS' ,
v_idepro varchar default 'RECNOM2100', v_idepcc varchar default 'MIYISHOME', v_keyusu numeric default 990001, v_fecini timestamp(0) default '22/12/2016', v_horini varchar default '21:00', cv_empdetails inout refcursor  default null) as $body$
declare
-- pgv moved types end
/*
