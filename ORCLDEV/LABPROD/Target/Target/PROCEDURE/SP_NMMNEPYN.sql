create or replace procedure labprod."sp_nmmnepyn"  (ws_nom_rep varchar, ws_ide_pcc varchar, wn_key_usu numeric, ws_key_men varchar, ws_hor_reg varchar, wn_key_pro numeric, ws_des_pro varchar, wn_key_nom numeric, ws_des_nom varchar) as $body$
declare
...
ws_des_lis varchar(50)    := sp_glgetrep('nmmneref', 'No existe nombre del Reporte', null);
