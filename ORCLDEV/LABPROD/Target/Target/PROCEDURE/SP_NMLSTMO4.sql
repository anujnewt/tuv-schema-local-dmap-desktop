create or replace procedure labprod."sp_nmlstmo4"  (ws_nom_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar,wn_key_pro numeric,ws_key_per varchar,wn_tip_rep numeric,ws_nom_rp1 varchar ) as $body$
declare
...
call labprod.sp_glgetdsp ('nmwkmovt', 'mov_cantid', ws_key_men,wn_dsp_001);
call labprod.sp_glgetdsp ('nmwkmovt', 'mov_import', ws_key_men,wn_dsp_002);
