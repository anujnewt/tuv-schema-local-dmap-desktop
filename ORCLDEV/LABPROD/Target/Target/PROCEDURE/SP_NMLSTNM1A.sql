create or replace procedure labprod."sp_nmlstnm1a"  (ws_nom_rep varchar,ws_des_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar,wn_key_pro numeric,wn_tip_nom numeric ) as $body$
declare
...
begin select oracle.substr(cia_descia,60), cia_rfccia
...
wn_dsp_009:=0;
wn_dsp_010:=0;
call labprod.sp_glnewdsp ('nmlohism', 'his_keyemp', ws_key_men,wn_dsp_001);
call labprod.sp_glnewdsp ('nmlohism', 'his_keydep', ws_key_men,wn_dsp_002);
call labprod.sp_glnewdsp ('nmlohism', 'his_keypue', ws_key_men,wn_dsp_003);
call labprod.sp_glnewdsp ('nmlohism', 'his_keycon', ws_key_men,wn_dsp_004);
call labprod.sp_glnewdsp ('nmlohism', 'his_keyper', ws_key_men,wn_dsp_005);
call labprod.sp_glnewdsp ('nmlohism', 'his_keynom', ws_key_men,wn_dsp_006);
call labprod.sp_glnewdsp ('nmlohism', 'his_cantid', ws_key_men,wn_dsp_007);
call labprod.sp_glnewdsp ('nmlohism', 'his_import', ws_key_men,wn_dsp_008);
call labprod.sp_glnewdsp ('nmlohism', 'emp_tipemp', ws_key_men,wn_dsp_009);
call labprod.sp_glnewdsp ('nmlohism', 'emp_keyloc', ws_key_men,wn_dsp_010);
wn_num_reg:=0;
wn_pct_act:=1;
...
into strict ws_des_li1 from labprod.glcolist
...
k:=1;
for c_nmlstnom in ( select his_keyemp, his_keycon,  sum(his_cantid ) alias3,  sum(his_import ) alias4, his_codimp from labprod.nmlohism
where his_keyemp in (
...
into strict ws_dep_his, ws_pue_his, ws_loc_his from labprod.nmlohism
