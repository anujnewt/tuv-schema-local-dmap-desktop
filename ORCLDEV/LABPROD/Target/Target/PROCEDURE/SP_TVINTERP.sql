create or replace procedure labprod."sp_tvinterp"  (wn_keypro numeric, ws_keyper varchar, wn_keynom numeric, wn_keycia numeric, ws_tippol varchar, ws_tiprep varchar, ws_nomrep varchar, ws_poliza varchar, ws_idepcc varchar, wn_keyusu numeric) as $body$
declare
