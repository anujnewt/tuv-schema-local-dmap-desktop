create or replace procedure labprod."sp_nmtrinc2"  ( wn_key_pro numeric, ws_per_fue varchar, wn_per_cer numeric, ws_nom_rep varchar, ws_ide_pcc varchar, wn_key_usu numeric, ws_per_des varchar, wn_rev_ers numeric, wn_key_inc numeric) as $body$
declare
