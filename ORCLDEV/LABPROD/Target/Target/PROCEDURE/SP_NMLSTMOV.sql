create or replace procedure labprod."sp_nmlstmov"  (ws_nom_rep varchar, ws_ide_pcc varchar, wn_key_usu numeric, ws_key_men varchar, ws_hor_reg varchar, wn_key_pro numeric, ws_key_per varchar, wn_tip_rep numeric, ws_nom_rp1 varchar) as $body$
declare
...
wn_dsp_001 numeric(5) := labprod.sp_glgetdsp1('nmwkmovt', 'mov_cantid', ws_key_men);
wn_dsp_002 numeric(5) := labprod.sp_glgetdsp1('nmwkmovt', 'mov_import', ws_key_men);
...
wn_can_ti2 labprod.glwkcrys.cry_dec003%type := null;
wn_can_tid labprod.glwkcrys.cry_dec001%type;
wn_imp_or2 labprod.glwkcrys.cry_dec004%type := null;
wn_imp_ort labprod.glwkcrys.cry_dec002%type;
ws_des_co2 labprod.glwkcrys.cry_chr004%type := null;
ws_des_con labprod.glwkcrys.cry_chr003%type;
ws_des_cor labprod.glwkcrys.cry_chr001%type := 'CORPORATIVO NO REGISTRADO ...';
ws_des_lis labprod.glwkcrys.cry_chr005%type := labprod.sp_glgetrep(ws_nom_rp1, 'No existe nombre del reporte...', 40);
ws_dia_act labprod.glwkcrys.cry_dat001%type := labprod.sp_glgetfec;
ws_etq_001 labprod.glwkcrys.cry_chr020%type := labprod.sp_glgetdsc('nmwkmovt', 'mov_keyemp', '........', null);
ws_etq_002 labprod.glwkcrys.cry_chr021%type := labprod.sp_glgetdsc('nmcoempl', 'emp_nomemp', '........', null);
ws_etq_003 labprod.glwkcrys.cry_chr006%type := labprod.sp_glgetdsl('nmwkmovt', 'mov_keycon', '........', null);
ws_etq_004 labprod.glwkcrys.cry_chr007%type := labprod.sp_glgetdsl('nmloconc', 'con_descon', '........', null);
ws_etq_005 labprod.glwkcrys.cry_chr008%type := labprod.sp_glgetdsl('nmwkmovt', 'mov_cantid', '........', 20);
ws_etq_006 labprod.glwkcrys.cry_chr009%type := labprod.sp_glgetdsl('nmwkmovt', 'mov_import', '........', 20);
ws_hor_act labprod.glwkcrys.cry_chr024%type := labprod.sp_glgethor;
ws_key_co2 labprod.glwkcrys.cry_chr025%type := null;
ws_key_con labprod.glwkcrys.cry_chr017%type;
ws_nom_emp labprod.glwkcrys.cry_chr002%type;
...
insert into labprod.glwkcrys(cry_nomrep, cry_idepcc, cry_keyusu, cry_chr001, cry_chr017, cry_chr003,
...
exception
when others then
call labprod.sp_glgenerr (ws_nom_rep, ws_ide_pcc, wn_key_usu, ws_hor_reg, sqlstate, 0,
