-- DMAP_OBJECT_GEN_TAG : TYPE : FUNCTION NAME : trigger_fct_nmcoempl_sdwi()
SET search_path = labprod,oracle,dmap_extension,public;
CREATE OR REPLACE FUNCTION trigger_fct_nmcoempl_sdwi() RETURNS trigger AS $BODY$
BEGIN
        call sp_trig_empl_i(post.emp_keyemp ,post.emp_keydep ,post.emp_keypue ,post.emp_keycen ,post.emp_keycat
