create or replace procedure labprod.tvcdesaf_afiliar (recurp nmcoempl.emp_recurp%type , cantid numeric, tipact numeric, keycon nmloconc.con_keycon%type, resultado inout numeric) as $body$
declare
...
tvcdesaf_local.afiliar__rtelecom(recurp, cantid, tipact, keycon, resultado);
*/
end if;end;
$body$
language plpgsql
