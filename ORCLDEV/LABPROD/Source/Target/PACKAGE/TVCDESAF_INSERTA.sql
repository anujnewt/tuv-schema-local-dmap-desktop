create or replace procedure labprod.tvcdesaf_inserta (recurp nmcoempl.emp_recurp%type , monsol numeric, mondes numeric, tipact numeric, cveref nmlopres.pre_refere%type, unipre numeric, unides numeric, unisal numeric, keycon nmloconc.con_keycon%type, resultado inout numeric) as $body$
declare
...
tvcdesaf_local.inserta__rtelecom (recurp, monsol, mondes, tipact, cveref, unipre, unides, unisal, keycon, resultado);
*/
end if;end;
$body$
language plpgsql
