create or replace procedure labprod.calculoisn_sp_sinaloa (wn_base numeric,ws_key_tab varchar,wn_por_adi numeric, wn_por_cen inout numeric,wn_imp_isn inout numeric, wn_imp_adi inout numeric) as $body$
declare
