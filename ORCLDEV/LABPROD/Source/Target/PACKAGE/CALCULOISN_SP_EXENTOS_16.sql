create or replace procedure labprod.calculoisn_sp_exentos_16 (ws_nom_rep varchar,ws_key_per varchar, wn_anio integer, wn_mes integer, wn_key_nom smallint) as $body$
declare
