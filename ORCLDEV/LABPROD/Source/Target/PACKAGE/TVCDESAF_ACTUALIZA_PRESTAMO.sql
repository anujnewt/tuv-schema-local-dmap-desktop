create or replace procedure labprod.tvcdesaf_actualiza_prestamo ( recurp nmcoempl.emp_recurp%type , cveref nmlopres.pre_refere%type, keycon nmloconc.con_keycon%type, resultado inout numeric) as $body$
declare
...
tvcdesaf_local.actualiza_prestamo__rtelecom (recurp, cveref, keycon, resultado);
*/
end if;end;
$body$
language plpgsql
