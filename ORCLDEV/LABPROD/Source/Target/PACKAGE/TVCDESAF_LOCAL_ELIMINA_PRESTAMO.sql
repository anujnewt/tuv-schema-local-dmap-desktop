create or replace procedure labprod.tvcdesaf_local_elimina_prestamo ( recurp labprod.nmcoempl.emp_recurp%type , cveref labprod.nmlopres.pre_refere%type, keycon labprod.nmloconc.con_keycon%type, resultado inout numeric) as $body$
declare
ora2pg_rowcount int;
...
if tvcdesaf_local_existe_prestamo(cveref, current_setting('tvcdesaf_local.v_empleado')::TVCDESAF_LOCAL_empleado.keyemp, keycon, 2034151) = 0 then
resultado := 3; return;
end if;
