create or replace procedure labprod.calculoisn_sp_exentos_vales (ws_nom_rep varchar,ws_key_per varchar, ws_key_ent varchar,wn_tope numeric, wn_limite numeric) as $body$
declare
