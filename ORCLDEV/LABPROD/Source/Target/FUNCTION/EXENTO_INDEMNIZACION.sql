create or replace  function  labprod."exento_indemnizacion"  (wd_fec_ing timestamp(0),wd_fec_baj timestamp(0), wn_imp_ort numeric, wn_uma numeric) returns numeric as $body$
declare
