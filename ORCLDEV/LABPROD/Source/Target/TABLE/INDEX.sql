...
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index pk_fuarchivo on fuarchivo (idarchivo);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index pk_fuarchivodetalle on fuarchivodetalle (id);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index pk_fucfdicomprobanteemp on fucfdicomprobanteemp (idcomprobanteemp);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index pk_fucfdicomprobantepro on fucfdicomprobantepro (idcomprobantepro);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
...
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index moconc01 on moloconc (con_keycon);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index idx_molosoli01 on molosoli (sol_keysol);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
...
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index nmcvac01_resp on nmcocvac_resp (vac_keyemp, vac_antigu);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
...
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index nmdata01 on nmlodata (dat_keyemp, dat_keypar);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
...
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index nmsem01 on nmlosema (sem_keysem);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
...
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index tvincl00 on tvloincl (inc_keyinc);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index tvlosete01 on tvlosete (enc_keylot, enc_keypro, enc_keyper);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index tvtiee03 on tvlotiee (tie_keytie);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index tvverc02 on tvloverc (ver_keyver, ver_keycon);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index idx_tvnomset_02 on tvnomset (mse_auxnu1);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index idx_wemail on wemail (keyemp);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index idx_wevaljef on wevaljef (val_keyemp);
-- dmap_object_gen_tag : type : unique name : index
set search_path = labprod,oracle,dmap_extension,public;
create unique index xxhr_rever_emp_lab_idx01 on xxhr_rever_emp_lab (id_labora);
