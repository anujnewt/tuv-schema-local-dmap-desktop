-- dmap_object_gen_tag : type : table name : nmloperi
set search_path = labprod,oracle,dmap_extension,public;
create table "nmloperi"  (
...
-- dmap_object_gen_tag : type : alter table name : nmloperi
set search_path = labprod,oracle,dmap_extension,public;
alter table nmloperi alter column per_keypro set not null;
-- dmap_object_gen_tag : type : alter table name : nmloperi
set search_path = labprod,oracle,dmap_extension,public;
alter table nmloperi alter column per_keyper set not null;
