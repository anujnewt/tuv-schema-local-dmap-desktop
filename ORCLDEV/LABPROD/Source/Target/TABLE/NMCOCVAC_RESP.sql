-- dmap_object_gen_tag : type : table name : nmcocvac_resp
set search_path = labprod,oracle,dmap_extension,public;
create table "nmcocvac_resp"  (
...
-- dmap_object_gen_tag : type : alter table name : nmcocvac_resp
set search_path = labprod,oracle,dmap_extension,public;
alter table nmcocvac_resp alter column vac_keyemp set not null;
-- dmap_object_gen_tag : type : alter table name : nmcocvac_resp
set search_path = labprod,oracle,dmap_extension,public;
alter table nmcocvac_resp alter column vac_antigu set not null;
