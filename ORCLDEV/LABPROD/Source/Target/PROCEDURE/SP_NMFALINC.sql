create or replace procedure labprod."sp_nmfalinc"  (ws_nom_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar,ws_fec_ha1 varchar,ws_fec_ha2 varchar ) as $body$
declare
