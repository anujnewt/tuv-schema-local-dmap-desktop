create or replace procedure labprod."sp_calculofinal"  (wn_key_pro numeric, ws_key_per varchar, ws_nom_rep varchar, ws_fec_ini varchar, ws_hor_ini varchar) as $body$
declare
