create or replace procedure labprod."sp_vac_cancelarsol"  ( keysol numeric, keyusu numeric, resultado inout numeric ) as $body$
declare
...
begin
update labprod.molosoli set sol_status = 5,sol_fecmod = clock_timestamp()   ,
