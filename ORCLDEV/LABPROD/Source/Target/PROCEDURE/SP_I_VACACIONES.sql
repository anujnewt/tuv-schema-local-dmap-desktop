create or replace procedure labprod."sp_i_vacaciones"  (o_num_r_procesados inout integer, o_num_r_insertados inout integer, o_num_r_actualizados inout integer, o_iregfijp inout integer, o_iregfijn inout integer) as $body$
declare
