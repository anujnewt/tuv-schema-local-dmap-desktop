create or replace procedure labprod."sp_bitacora"  (wn_key_usu numeric, ws_log_usu varchar, ws_ide_pcc varchar, ws_tip_mov varchar, ws_key_001 varchar, ws_key_002 varchar, ws_key_003 varchar, ws_val_001 varchar, ws_val_002 varchar, ws_val_003 varchar, ws_des_men varchar) as $body$
declare
...
insert into glwkcrys(cry_nomrep, cry_idepcc, cry_keyusu, cry_dat001, cry_chr012)
values (ws_ide_bit, ws_ide_pcc, wn_key_usu, ws_fec_mov, ws_hor_mov);
insert into glcobita(bit_keyusu, bit_logusu, bit_idepcc, bit_fecmov, bit_hormov,
...
exception
when others then
call sp_glgenerr ('BITACORA', ws_ide_pcc, wn_key_usu, ws_hor_mov,
