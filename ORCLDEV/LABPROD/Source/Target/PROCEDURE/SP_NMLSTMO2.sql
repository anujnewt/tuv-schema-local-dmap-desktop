create or replace procedure labprod."sp_nmlstmo2"  (ws_nom_rep varchar, ws_ide_pcc varchar, wn_key_usu numeric, ws_key_men varchar, ws_hor_reg varchar, wn_key_pro numeric, wn_key_per varchar, wn_tip_rep numeric, ws_nom_rp1 varchar) as $body$
declare
