create or replace procedure labprod."sp_nmcihdep"  (ws_nom_rep varchar,ws_ide_pcc varchar,ws_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar,ws_lis_per varchar,ws_dep_pri varchar,ws_key_est varchar ) as $body$
declare
...
into strict wn_mov_emp from labprod.nmlohism, labprod.eocorede
...
begin select  count( distinct his_keyemp ) alias1
into strict wn_tot_emp from labprod.nmlohism, labprod.eocorede
