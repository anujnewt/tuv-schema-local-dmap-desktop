create or replace procedure labprod."sp_nmreppr1"  (ws_nom_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar,ws_sta_tu1 varchar,ws_sta_tu2 varchar,ws_sta_tu3 varchar,ws_sta_tu4 varchar,wn_key_pro numeric,ws_des_pro varchar ) as $body$
declare
...
into strict wn_tot_reg from labprod.nmlopres
...
call labprod.sp_glnewdsp ('nmlopres', 'pre_keycon', ws_key_men,wn_dsp_001);
call labprod.sp_glnewdsp ('nmlopres', 'pre_keyemp', ws_key_men,wn_dsp_003);
call labprod.sp_glnewdsp ('nmlopres', 'pre_fecreg', ws_key_men,wn_dsp_005);
call labprod.sp_glnewdsp ('nmlopres', 'pre_unipre', ws_key_men,wn_dsp_006);
call labprod.sp_glnewdsp ('nmlopres', 'pre_imppre', ws_key_men,wn_dsp_007);
call labprod.sp_glnewdsp ('nmlopres', 'pre_unisal', ws_key_men,wn_dsp_008);
call labprod.sp_glnewdsp ('nmlopres', 'per_impsal', ws_key_men,wn_dsp_009);
call labprod.sp_glnewdsp ('nmlopres', 'pre_plazop', ws_key_men,wn_dsp_010);
call labprod.sp_glnewdsp ('nmlopres', 'pre_porint', ws_key_men,wn_dsp_011);
call labprod.sp_glnewdsp ('nmlopres', 'pre_numpag', ws_key_men,wn_dsp_012);
call labprod.sp_glnewdsp ('nmlopres', 'pre_perini', ws_key_men,wn_dsp_013);
call labprod.sp_glnewdsp ('nmlopres', 'pre_status', ws_key_men,wn_dsp_014);
call labprod.sp_glnewdsp ('nmlopres', 'pre_refere', ws_key_men,wn_dsp_015);
call labprod.sp_glnewdsp ('nmlopres', 'pre_unides', ws_key_men,wn_dsp_016);
call labprod.sp_glnewdsp ('nmlopres', 'pre_impdes', ws_key_men,wn_dsp_017);
call labprod.sp_glnewdsp ('nmlopres', 'pre_uniamo', ws_key_men,wn_dsp_018);
call labprod.sp_glnewdsp ('nmlopres', 'pre_impamo', ws_key_men,wn_dsp_019);
call labprod.sp_glnewdsp ('nmlopres', 'pre_gastos', ws_key_men,wn_dsp_020);
call labprod.sp_glnewdsp ('nmlopres', 'pre_fecini', ws_key_men,wn_dsp_021);
call labprod.sp_glnewdsp ('nmlopres', 'pre_fecaut', ws_key_men,wn_dsp_022);
call labprod.sp_glnewdsp ('nmlopres', 'pre_cveaut', ws_key_men,wn_dsp_023);
call labprod.sp_glnewdsp ('nmlopres', 'pre_fechab', ws_key_men,wn_dsp_024);
call labprod.sp_glnewdsp ('nmlopres', 'pre_fe1aux', ws_key_men,wn_dsp_025);
call labprod.sp_glnewdsp ('nmlopres', 'pre_fe2aux', ws_key_men,wn_dsp_026);
wn_pro_ant:=-32760;
wn_nom_ant:=-32760;
wn_num_reg:=0;
wn_pct_act:=1;
