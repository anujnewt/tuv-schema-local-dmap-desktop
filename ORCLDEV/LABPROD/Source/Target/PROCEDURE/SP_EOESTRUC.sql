create or replace procedure labprod."sp_eoestruc"  (ws_nvo_nom varchar,ws_nom_ant varchar,ws_sub_mov varchar,wf_fec_mov timestamp(0),ws_est_ant varchar,ws_est_act varchar,ws_est_ope varchar ) as $body$
declare
