create or replace procedure labprod."sp_detbitac"  (wn_key_usu numeric, ws_ide_pcc varchar, ws_key_tab varchar, ws_key_cam varchar, ws_val_ant varchar, ws_val_act varchar) as $body$
declare
