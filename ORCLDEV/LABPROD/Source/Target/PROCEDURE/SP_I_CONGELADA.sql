create or replace procedure labprod."sp_i_congelada"  (ws_mes varchar, wi_proceso smallint, ws_periodo varchar, ws_anio varchar, ws_estruc varchar, total inout integer) as $body$
declare
