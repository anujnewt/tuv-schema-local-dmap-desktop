...
create foreign  table amortizaciones (
...
amo_status numeric
) server  options(schema 'LABPROD', table 'AMORTIZACIONES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table apirestriccionacceso (
usuario varchar(30) not null,
fecha timestamp(0) not null,
accion numeric not null
) server  options(schema 'LABPROD', table 'APIRESTRICCIONACCESO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table api_catalogo (
...
code varchar(200),
message varchar(200)
) server  options(schema 'LABPROD', table 'API_CATALOGO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table api_departamento (
id_transaccion varchar(30) not null,
...
fecha_insert timestamp(0),
fecha_proc timestamp(0)
) server  options(schema 'LABPROD', table 'API_DEPARTAMENTO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table api_empleadosda (
id_transaccion varchar(30) not null,
...
message varchar(150),
fecha timestamp(0)
) server  options(schema 'LABPROD', table 'API_EMPLEADOSDA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table api_eocoplza (
id_transaccion varchar(30) not null,
...
fecha_insert timestamp(0),
fecha_proc timestamp(0)
) server  options(schema 'LABPROD', table 'API_EOCOPLZA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table api_locpago (
id_transaccion varchar(30) not null,
...
fecha_insert timestamp(0),
fecha_proc timestamp(0)
) server  options(schema 'LABPROD', table 'API_LOCPAGO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table api_movimientosper (
id_transaccion varchar(30) not null,
...
) server  options(schema 'LABPROD', table 'API_MOVIMIENTOSPER', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table api_nmlocenc (
id_transaccion varchar(30) not null,
...
code varchar(150),
message varchar(255)
) server  options(schema 'LABPROD', table 'API_NMLOCENC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table api_puesto (
id_transaccion varchar(30) not null,
...
fecha_insert timestamp(0),
fecha_proc timestamp(0)
) server  options(schema 'LABPROD', table 'API_PUESTO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table api_regpat_imss (
id_transaccion varchar(30) not null,
...
fecha_insert timestamp(0),
fecha_proc timestamp(0)
) server  options(schema 'LABPROD', table 'API_REGPAT_IMSS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'AP_SIPROS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table autryc (
emp_keyemp numeric(38),
emp_keyloc varchar(16)
) server  options(schema 'LABPROD', table 'AUTRYC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
keypro numeric(38),
keyper char(7)
) server  options(schema 'LABPROD', table 'AUX_ACUM3', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
field3 numeric(38),
field4 varchar(100)
) server  options(schema 'LABPROD', table 'BORRA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2CANCELACIONES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
objetoimp varchar(2)
) server  options(schema 'LABPROD', table 'CFDI2COMPROBANTECONCEPTOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2COMPROBANTEEMISOR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2COMPROBANTEEMP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2COMPROBANTEPRO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
usocfdi varchar(5)
) server  options(schema 'LABPROD', table 'CFDI2COMPROBANTERECEPTOR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2CONF', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2DEDUCCIONESDETALLE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
totalimpuestosretenidos decimal(18,2)
) server  options(schema 'LABPROD', table 'CFDI2DEDUCCIONESTOTAL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2ERRORES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2ESTATUSRECIBOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2HORASEXTRA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2INCAPACIDADES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2NOMINA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2NOMINAEMISOR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2NOMINARECEPTOR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2OTROSPAGOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2PERCEPCIONESDETALLE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2PERCEPCIONESJUBILACION', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ingresoacumulable decimal(18,2) not null,
ingresonoacumulable decimal(18,2) not null
) server  options(schema 'LABPROD', table 'CFDI2PERCEPCIONESSEPARACION', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2PERCEPCIONESTOTAL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table cfdi2qr (
idcomprobanteemp numeric(10) options (key 'true') not null,
qrcode bytea
) server  options(schema 'LABPROD', table 'CFDI2QR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
rel_uuid varchar(36)
) server  options(schema 'LABPROD', table 'CFDI2RELACIONADOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
importegravado decimal(18,2) not null,
importeexento decimal(18,2) not null
) server  options(schema 'LABPROD', table 'CFDI2REPORTECIFRAS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
xmlcfdi2 text
) server  options(schema 'LABPROD', table 'CFDI2REPOSITORIOXML', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDI2SUBCONTRATACION', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table cfdicancelaciones (
...
can_pac varchar(50)
) server  options(schema 'LABPROD', table 'CFDICANCELACIONES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
valorunitario decimal(18,6) not null,
importe decimal(18,6) not null
) server  options(schema 'LABPROD', table 'CFDICOMPROBANTECONCEPTOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
pais varchar(100),
codigopostal varchar(5)
) server  options(schema 'LABPROD', table 'CFDICOMPROBANTEEMISOR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDICOMPROBANTEEMP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDICOMPROBANTEPRO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
pais varchar(100),
codigopostal varchar(5)
) server  options(schema 'LABPROD', table 'CFDICOMPROBANTERECEPTOR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
con_heximp varchar(6),
con_diapag varchar(6)
) server  options(schema 'LABPROD', table 'CFDICONF', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDIDEDUCCIONES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDIERRORES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDIHORASEXTRA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
descuento decimal(18,6) not null
) server  options(schema 'LABPROD', table 'CFDIINCAPACIDADES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDINOMINA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CFDIPERCEPCIONES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table cfdiregimen (
idcomprobantepro numeric(38) options (key 'true') not null,
regimen varchar(250)
) server  options(schema 'LABPROD', table 'CFDIREGIMEN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
domiciliofiscalreceptor varchar(5),
version varchar(5)
) server  options(schema 'LABPROD', table 'CFDIXPOLIZA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table comcias (
numcia varchar(4) not null,
nomcia varchar(60) not null
) server  options(schema 'LABPROD', table 'COMCIAS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
version numeric,
cve_anio numeric
) server  options(schema 'LABPROD', table 'COMPARATIVO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table comtporegistro (
numtporeg numeric(38) not null,
destporeg char(60) not null
) server  options(schema 'LABPROD', table 'COMTPOREGISTRO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'COM_ORAC_SIPS_BITA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'COM_ORAC_SIPS_CAMP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'COM_ORAC_SIPS_DATA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
dep_ca4aux varchar(10),
dep_ca5aux varchar(10)
) server  options(schema 'LABPROD', table 'COM_ORAC_SIPS_DEPS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
emp_est varchar(2)
) server  options(schema 'LABPROD', table 'COM_ORAC_SIPS_EMPL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
plz_tiptab varchar(2),
ora_status varchar(2)
) server  options(schema 'LABPROD', table 'COM_ORAC_SIPS_PLZS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'COM_ORAC_SIPS_PUES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ora_status varchar(2)
) server  options(schema 'LABPROD', table 'COM_ORAC_SIPS_TRAY', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'COM_SIPS_ORAC_BITA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'COM_SIPS_ORAC_EMPL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CONGELADA_RH2000', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
aux1 varchar(200),
aux2 varchar(200)
) server  options(schema 'LABPROD', table 'CONTRATOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'CUENTAS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'DATAPASO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table datosgenerales (
...
) server  options(schema 'LABPROD', table 'DATOSGENERALES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table datosgenerales_errsaf (
empleado numeric(10) not null,
tipo varchar(10) not null,
fecha timestamp(0) not null,
query varchar(300)
) server  options(schema 'LABPROD', table 'DATOSGENERALES_ERRSAF', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'DETALLEPARAMETROS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'DET_CAPINC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'DET_COMPARA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table dias_festivos (
id numeric(38),
fecha timestamp(0),
detalle varchar(40)
) server  options(schema 'LABPROD', table 'DIAS_FESTIVOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table edlotipe (
tip_keytip varchar(6),
tip_destip varchar(40)
) server  options(schema 'LABPROD', table 'EDLOTIPE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
emp_cobert varchar(2),
emp_est varchar(2)
) server  options(schema 'LABPROD', table 'EMPLPASO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOCODECP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOCOENCP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
plz_ca7aux varchar(100),
plz_ca8aux varchar(100)
) server  options(schema 'LABPROD', table 'EOCOPLZA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table eocoplza_resp (
plz_keyest varchar(3),
plz_keydep varchar(16),
plz_keypue varchar(16),
plz_keyplz numeric(38),
...
plz_limocu timestamp(0),
plz_tiptab varchar(2)
) server  options(schema 'LABPROD', table 'EOCOPLZA_RESP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOCOREDE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOLODEST', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOLODPLA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
plz_keyusu numeric
) server  options(schema 'LABPROD', table 'EOLOHPLZ', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOLOMVPZ', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOLOORGN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOLOPLAN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOLORECA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOLOREOR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOLOSOLC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'EOLOTPLZ', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table fuarchivo (
idarchivo numeric(38),
nombrearchivo varchar(100),
fechacarga timestamp(0),
total_registros numeric(38)
) server  options(schema 'LABPROD', table 'FUARCHIVO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table fuarchivodetalle (
id numeric(38),
idarchivo numeric(38),
serie varchar(10),
folio varchar(10),
...
) server  options(schema 'LABPROD', table 'FUARCHIVODETALLE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table fuarchivoxml (
...
sellosat varchar(4000),
nocertificadosat varchar(50)
) server  options(schema 'LABPROD', table 'FUARCHIVOXML', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table fucfdicomprobanteemp (
...
totalimpuestosretenidos decimal(18,2),
exportacion varchar(2)
) server  options(schema 'LABPROD', table 'FUCFDICOMPROBANTEEMP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table fucfdicomprobantepro (
idcomprobantepro numeric(38),
...
) server  options(schema 'LABPROD', table 'FUCFDICOMPROBANTEPRO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table fucfdixml (
idcomprobanteemp numeric(10) options (key 'true') not null,
xmlcfdi varchar(4000),
timbrado numeric(1),
cadenaoriginal varchar(4000),
...
sellosat varchar(4000),
nocertificadosat varchar(50)
) server  options(schema 'LABPROD', table 'FUCFDIXML', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOACAR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOARGU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOBATC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOBINY', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOBITA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOCAMP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOCORP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCODATS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCODECO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCODETB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCODOCD', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCODOCU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOERRO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOEVEN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOFMTS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOFVAL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOHIPA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOJOIN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table glcolist (
lis_keylis varchar(12),
lis_deslis varchar(50)
) server  options(schema 'LABPROD', table 'GLCOLIST', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOMAGE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOMENU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOMOTI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
pam_folini varchar(100),
pam_folfin varchar(100)
) server  options(schema 'LABPROD', table 'GLCOPAMS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
pam_folini varchar(100),
pam_folfin varchar(100)
) server  options(schema 'LABPROD', table 'GLCOPAMS_AUX', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table glcopams_aux (
pam_keypar varchar(4),
...
) server  options(schema 'LABPROD', table 'GLCORECA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCORESU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOSEDA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOSWIT', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table glcotabl (
tab_keytab varchar(40),
tab_destab varchar(50)
) server  options(schema 'LABPROD', table 'GLCOTABL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLCOUSUA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table glwkcri (
cry_chr001 varchar(100),
cry_chr002 varchar(100),
cry_chr004 varchar(100),
cry_chr005 varchar(100),
cry_chr012 varchar(100),
cry_chr013 varchar(100),
cry_chr014 varchar(100),
cry_chr017 varchar(100),
cry_chr018 varchar(100),
...
i_ctnm numeric,
i_cta numeric
) server  options(schema 'LABPROD', table 'GLWKCRI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
cry_chr001 varchar(100),
cry_chr002 varchar(100),
cry_chr003 varchar(100),
cry_chr004 varchar(100),
cry_chr005 varchar(100),
cry_chr006 varchar(100),
cry_chr007 varchar(100),
cry_chr008 varchar(100),
cry_chr009 varchar(100),
cry_chr010 varchar(100),
cry_chr011 varchar(100),
cry_chr012 varchar(100),
cry_chr013 varchar(100),
cry_chr014 varchar(100),
cry_chr015 varchar(100),
cry_chr016 varchar(100),
cry_chr017 varchar(100),
cry_chr018 varchar(100),
cry_chr019 varchar(100),
cry_chr020 varchar(8),
cry_chr021 varchar(8),
cry_chr022 varchar(8),
cry_chr023 varchar(8),
cry_chr024 varchar(20),
...
) server  options(schema 'LABPROD', table 'GLWKCRYS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLWKPLEM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'GLWKRANG', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'HIST_DATOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOCUEM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOCUFC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table inlocupu (
cup_keypue varchar(16),
cup_keycur varchar(8)
) server  options(schema 'LABPROD', table 'INLOCUPU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOCURS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLODGPO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLODNCA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLODWOR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLODWSQ', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOETAP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOEVEM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOFCAP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOGPOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOHIGR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOHISC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOHOGR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOINEQ', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOINST', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOKARD', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOLUGS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOMACU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOMOEQ', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOPCAP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOPGRA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOPPRO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOPRCA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOWORD', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'INLOWSQL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
inv varchar(40),
info varchar(500)
) server  options(schema 'LABPROD', table 'INVINFO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table invrequest (
ssn numeric,
fund_id numeric
) server  options(schema 'LABPROD', table 'INVREQUEST', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
con_tipope varchar(1)
) server  options(schema 'LABPROD', table 'ISNCONF', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ent_anio numeric(4)
) server  options(schema 'LABPROD', table 'ISNENTIDADES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'ISNTOTALES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table mail (
usuario varchar(60),
emp_keyemp numeric(38),
email varchar(50)
) server  options(schema 'LABPROD', table 'MAIL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'MOLOCALE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'MOLOCONC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'MOLODCAL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'MOLODIAD', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table molosoli (
...
) server  options(schema 'LABPROD', table 'MOLOSOLI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'MOLOTRPR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'MUCONCEN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
nombre char(60),
importe decimal(18,6)
) server  options(schema 'LABPROD', table 'NACIMIENTO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCALINCI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCAPIMS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCAPINC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmcocper (
...
) server  options(schema 'LABPROD', table 'NMCOCPER', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCOCVAC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmcocvac_resp (
vac_keyemp numeric(38) not null,
vac_antigu numeric(38) not null,
vac_diavac decimal(6,2),
vac_period varchar(10),
...
vac_status varchar(1),
vac_cosrea decimal(10,2)
) server  options(schema 'LABPROD', table 'NMCOCVAC_RESP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCOCVAL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
dep_ca4aux varchar(10),
dep_ca5aux varchar(10)
) server  options(schema 'LABPROD', table 'NMCODEPS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmcodeps1 (
dep_keydep varchar(16) not null,
dep_desdep varchar(40) not null,
dep_refcon varchar(20),
dep_keycen varchar(16),
...
dep_ca4aux varchar(10),
dep_ca5aux varchar(10)
) server  options(schema 'LABPROD', table 'NMCODEPS1', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCODFOR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
emp_finfec timestamp(0),
emp_cobert varchar(2)
) server  options(schema 'LABPROD', table 'NMCOEMPL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCOEMPL_SDW', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCOESTR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCOFALT', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCOFORP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCOINCI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmconcst (
cst_keycve numeric(38) not null,
cst_keycon char(3) not null
) server  options(schema 'LABPROD', table 'NMCONCST', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCOOANA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
pue_subgrp varchar(16),
pue_tippue varchar(2)
) server  options(schema 'LABPROD', table 'NMCOPUES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCOPVAC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCORVAC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCOTARP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMCOTVAC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMDESCAN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
inc_keypro numeric(38),
inc_keyper varchar(7)
) server  options(schema 'LABPROD', table 'NMDETINC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
inc_keypro numeric(38),
inc_keyper varchar(7)
) server  options(schema 'LABPROD', table 'NMENCINC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMEXENINCI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMHISINC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMHORAST', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMJORLAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOACUM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOAMOR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOAPOV', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOBANC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOBASC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOBEBE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOBENE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCALC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCANR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCATE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCCOL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
cen_ca4aux varchar(10),
cen_ca5aux varchar(10)
) server  options(schema 'LABPROD', table 'NMLOCENC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
cen_neg varchar(2),
cen_cta varchar(3)
) server  options(schema 'LABPROD', table 'NMLOCEPRO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmlocepro_historico (
cen_keycen varchar(16),
cen_descen varchar(40),
cen_refcon varchar(20),
cen_status varchar(3),
cen_nu1axu varchar(3)
) server  options(schema 'LABPROD', table 'NMLOCEPRO_HISTORICO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCFGN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCIAS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCIER', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCOCO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCONC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCOSA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCTAS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOCXPR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
dat_valpar varchar(30)
) server  options(schema 'LABPROD', table 'NMLODATA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLODATN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLODCCF', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLODCCN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLODCDE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLODCEM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLODFIJ', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmloenfm (
enf_keyfor varchar(4) not null,
enf_de1for varchar(40),
enf_de2for varchar(40),
enf_de3for varchar(40),
enf_idever varchar(15)
) server  options(schema 'LABPROD', table 'NMLOENFM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOFOCO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmlofond (
...
) server  options(schema 'LABPROD', table 'NMLOFOND', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmlofone (
fon_keyfon numeric(10) not null,
...
) server  options(schema 'LABPROD', table 'NMLOFONE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOFORM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOHEMP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOHICO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOHISM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOIMEM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ims_ca4aux varchar(20),
ims_franum varchar(8)
) server  options(schema 'LABPROD', table 'NMLOIMSS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmloinfo (
...
) server  options(schema 'LABPROD', table 'NMLOINFO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOLIPR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOLOCP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOMASI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOMNEM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOMRNM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOMXPR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmlonomi (
nom_keynom numeric(5) not null,
nom_destip varchar(40) not null
) server  options(schema 'LABPROD', table 'NMLONOMI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOPCOL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOPERI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOPRES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmloproc (
pro_keypro numeric(5) not null,
pro_despro varchar(20) not null,
...
) server  options(schema 'LABPROD', table 'NMLOPROC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLORCON', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOREPC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmlosema (
...
) server  options(schema 'LABPROD', table 'NMLOSEMA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOSUEL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOSWDE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOSWIT', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOTABN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOTABS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOTANU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOTIPR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOTRAY', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMLOVERC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
usr_nomusr char(35),
usr_passwd char(10)
) server  options(schema 'LABPROD', table 'NMMODUSR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
inc_semana numeric(38),
inc_sempro varchar(50)
) server  options(schema 'LABPROD', table 'NMPASINC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmproche (
che_keypro numeric(5) options (key 'true') not null,
che_keyper varchar(7) options (key 'true') not null,
che_keyemp numeric(10) options (key 'true') not null,
...
id numeric(10)
) server  options(schema 'LABPROD', table 'NMPROCHE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMRECNOM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmreltab (
rel_keypro numeric(3),
rel_idetab varchar(5),
rel_essind varchar(1)
) server  options(schema 'LABPROD', table 'NMRELTAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMSTAUSU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmtabayu (
tab_idetab varchar(5),
tab_destab varchar(35),
tab_transp decimal(5,2),
tab_desayu decimal(5,2),
tab_comida decimal(5,2),
tab_cena decimal(5,2),
tab_pasaje decimal(5,2),
tab_gastra decimal(5,2),
tab_monnoc decimal(5,2),
tab_maxali varchar(11)
) server  options(schema 'LABPROD', table 'NMTABAYU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMTARJET', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
vis_gpo varchar(10)
) server  options(schema 'LABPROD', table 'NMVISTAR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKCP10', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
cpr_folope varchar(20),
cpr_sireac varchar(2)
) server  options(schema 'LABPROD', table 'NMWKCPR3', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
cpr_folope varchar(20),
cpr_sireac varchar(2)
) server  options(schema 'LABPROD', table 'NMWKCPR4', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
cpr_folope varchar(20),
cpr_sireac varchar(2)
) server  options(schema 'LABPROD', table 'NMWKCPR5', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
cpr_folope varchar(20),
cpr_sireac varchar(2)
) server  options(schema 'LABPROD', table 'NMWKCPR6', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKDECL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKETQC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKHISM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKLSTC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKMOFI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKMOSU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKMOVT', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table nmwkmovt_his_to_2014 (
mov_keyemp numeric(10),
mov_keycon varchar(3),
mov_keynom numeric(5),
mov_keydep varchar(16),
...
mov_keyben numeric(5),
mov_comfam numeric(5)
) server  options(schema 'LABPROD', table 'NMWKMOVT_HIS_TO_2014', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKPERC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKPOLI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKPOLI2', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKRENO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'NMWKURNO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table pasexep (
pas_keyemp numeric(38)
) server  options(schema 'LABPROD', table 'PASEXEP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLCOENTO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOCELD', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOCHKF', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOCLXH', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOCNXH', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOCOLS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOCONC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOCVER', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOECOL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOECON', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOEPER', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOETQR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table plloexmi (
exm_keymin varchar(5),
exm_keyest varchar(5)
) server  options(schema 'LABPROD', table 'PLLOEXMI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOHJPN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOHOJA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOHXLI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOINFO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOLIBR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table pllolxmn (
lxm_keymin varchar(5),
lxm_keylib varchar(5)
) server  options(schema 'LABPROD', table 'PLLOLXMN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOMINF', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table plloorig (
ori_keyori varchar(5),
ori_desori varchar(30)
) server  options(schema 'LABPROD', table 'PLLOORIG', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOPANL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOPCEL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOPERI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOPNCL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOPNCN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOREPO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table pllorubr (
rub_keyrub varchar(5),
rub_desrub varchar(40)
) server  options(schema 'LABPROD', table 'PLLORUBR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOTABL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOTIPE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOTMCE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
cel_msknu2 varchar(15),
cel_islock double precision
) server  options(schema 'LABPROD', table 'PLLOTMPC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table pllovars (
var_keyvar varchar(5),
var_desvar varchar(25)
) server  options(schema 'LABPROD', table 'PLLOVARS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOVERS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PLLOVXEN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
plz_limocu timestamp(0),
plz_tiptab varchar(2)
) server  options(schema 'LABPROD', table 'PLZAPASO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PPLOVERS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PPPAGRALES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'PS_TPW_MSGXCONCS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
msg_nompar varchar(155) not null,
msg_folini varchar(16) not null,
msg_folfin varchar(16) not null
) server  options(schema 'LABPROD', table 'RBOSMSGS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'RECIBOS_GENERACION', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
eje_mensaj varchar(4000),
eje_error numeric(1) not null
) server  options(schema 'LABPROD', table 'RECIBOS_INTERFACE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table res_hrms_nmlotray (
tra_keyemp numeric(10) not null,
tra_fecmov timestamp(0),
tra_tipmov varchar(2),
tra_keydep varchar(16),
...
tra_fecmod timestamp(0),
tra_hormod varchar(10)
) server  options(schema 'LABPROD', table 'RES_HRMS_NMLOTRAY', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'RPCODEQU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'RPCODERP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'RPCOENQU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'RPCOENRP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'RPCOETIQ', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'RPCOSEGM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'RPCOSEGU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'RPCOSPRO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'RPFMTCAM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SCCOBAJA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SCCOCOMA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SCLODEPU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
fac_valor numeric(5)
) server  options(schema 'LABPROD', table 'SCLOFACT', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SCLOFURE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SCLOPESO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SCLOREQU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SCLOSOCO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SCLOSOEM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SHLOACCI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SHLOCODI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SHLODEAC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SHLODECD', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SHLODEHI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SHLOEVME', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SHLOHICL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SIPROS_ERP_CAIETU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'SIPROS_ERP_DET', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table sipros_erp_det_aux (
apd_keypol varchar(30),
apd_fecpol timestamp(0),
apd_numlin numeric(38),
apd_ciaemi varchar(3),
...
apd_auxca1 varchar(20),
apd_caietu numeric(38)
) server  options(schema 'LABPROD', table 'SIPROS_ERP_DET_AUX', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table sipros_erp_det_his (
apd_keypol varchar(30),
apd_fecpol timestamp(0),
apd_numlin numeric(38),
apd_ciaemi varchar(3),
...
apd_auxca1 varchar(20),
apd_caietu numeric(38)
) server  options(schema 'LABPROD', table 'SIPROS_ERP_DET_HIS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
apd_auxca1 varchar(20),
apd_caietu numeric(38)
) server  options(schema 'LABPROD', table 'SIPROS_ERP_DET_TMP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ape_auxnu1 numeric(38),
ape_auxca1 varchar(100)
) server  options(schema 'LABPROD', table 'SIPROS_ERP_ENC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table sipros_erp_enc_his (
ape_keypol varchar(30),
ape_fecpol timestamp(0),
ape_despro varchar(40),
ape_tipfac varchar(8),
...
ape_auxnu1 numeric(38),
ape_auxca1 varchar(100)
) server  options(schema 'LABPROD', table 'SIPROS_ERP_ENC_HIS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table sipros_erp_enc_tmp (
ape_keypol varchar(30),
ape_fecpol timestamp(0),
ape_despro varchar(40),
ape_tipfac varchar(8),
...
ape_auxnu1 numeric(38),
ape_auxca1 varchar(100)
) server  options(schema 'LABPROD', table 'SIPROS_ERP_ENC_TMP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table solvacnoper (
emp_vacsol numeric(10),
emp_vacdep numeric(10),
emp_autori varchar(40)
) server  options(schema 'LABPROD', table 'SOLVACNOPER', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table svconfig (
nom_param varchar(60) not null,
val_param numeric not null,
des_param varchar(60) not null
) server  options(schema 'LABPROD', table 'SVCONFIG', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table svtempdia (
num_emp numeric,
num_dia timestamp(0) not null,
is_medio numeric(38) not null,
per_vac char(10) not null
) server  options(schema 'LABPROD', table 'SVTEMPDIA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table svtempsc (
id_ope numeric,
num_emp numeric,
...
fec_sol timestamp(0),
con_emp numeric
) server  options(schema 'LABPROD', table 'SVTEMPSC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TMPCONREC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TMPCONREC2', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
dia numeric(38),
mes numeric(38)
) server  options(schema 'LABPROD', table 'TMPRECIBOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
f78 numeric(38),
f79 numeric(38)
) server  options(schema 'LABPROD', table 'TMP_TVNIVSUE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
tra_fecmod timestamp(0),
tra_hormod varchar(8)
) server  options(schema 'LABPROD', table 'TRAYPASO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
pde_horant char(10),
pde_hormov char(10)
) server  options(schema 'LABPROD', table 'TVCAPDES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVCAPDES_I', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVCONAGP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvdiaobl (
dob_fecha timestamp(0) not null,
dob_descri varchar(50)
) server  options(schema 'LABPROD', table 'TVDIAOBL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvgascar (
car_keycar numeric(38) options (key 'true') not null,
...
) server  options(schema 'LABPROD', table 'TVGASCAR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvgasdet (
det_keydet numeric(38) options (key 'true') not null,
...
) server  options(schema 'LABPROD', table 'TVGASDET', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvincsaf (
...
) server  options(schema 'LABPROD', table 'TVINCSAF', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVLOBADI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvlocope (
cop_keypol varchar(10),
cop_keypro numeric(38),
cop_keyper varchar(7),
cop_cuenta varchar(3),
cop_keycon varchar(3)
) server  options(schema 'LABPROD', table 'TVLOCOPE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvloenvi (
...
) server  options(schema 'LABPROD', table 'TVLOENVI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVLOFACD', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVLOFACE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVLOFAEM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvlofini (
...
) server  options(schema 'LABPROD', table 'TVLOFINI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVLOHALT', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvloincl (
...
) server  options(schema 'LABPROD', table 'TVLOINCL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvloinct (
inc_keyinc numeric(38) options (key 'true') not null,
...
) server  options(schema 'LABPROD', table 'TVLOINCT', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvlosetc (
id numeric,
set_keycia varchar(5),
set_keyban varchar(3),
set_ctaban varchar(20),
set_banpri varchar(1)
) server  options(schema 'LABPROD', table 'TVLOSETC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvlosete (
...
) server  options(schema 'LABPROD', table 'TVLOSETE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvlotiee (
...
) server  options(schema 'LABPROD', table 'TVLOTIEE', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVLOVERC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table tvlovxnom (
vxn_keynom numeric(9) not null,
vxn_keyver numeric(9) not null
) server  options(schema 'LABPROD', table 'TVLOVXNOM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVNOMSET', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVPBINCC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVPBVACC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
pva_dia decimal(3,2)
) server  options(schema 'LABPROD', table 'TVPERVAC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVPMOCAJ', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVPRBITA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVPRDETB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVPRETAR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'TVWKPOLI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table userred (
num_emp numeric(38),
emp_keyred varchar(60),
fec_sol varchar(10)
) server  options(schema 'LABPROD', table 'USERRED', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table usuarioapi (
id numeric not null,
usuario varchar(30) not null,
...
) server  options(schema 'LABPROD', table 'USUARIOAPI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'WEACCAUT', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'WEACCEMP', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table weaccusu (
usu_keyemp numeric(38) options (key 'true') not null,
wea_keyemp varchar(50)
) server  options(schema 'LABPROD', table 'WEACCUSU', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'WEBITACC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
bit_hora varchar(8),
bit_ip varchar(20)
) server  options(schema 'LABPROD', table 'WEBITACORA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
wcc_detall varchar(100) not null,
wcc_fecalt timestamp(0) not null
) server  options(schema 'LABPROD', table 'WEBITACT', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'WECOHIPA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table wecopass (
pas_keyemp varchar(50),
pas_keypas varchar(50)
) server  options(schema 'LABPROD', table 'WECOPASS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'WEHISPASS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table wemail (
keyemp numeric(38),
email varchar(200)
) server  options(schema 'LABPROD', table 'WEMAIL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'WEPARDET', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'WEPARMEN', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'WEPARPRO', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
estatus numeric(38),
error varchar(200)
) server  options(schema 'LABPROD', table 'WESEND', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'WESUPERV', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'WEVALJEF', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
nocertificadosat varchar(50)
) server  options(schema 'LABPROD', table 'XML_CFDI', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
tim_iddsap numeric
) server  options(schema 'LABPROD', table 'XXAP_TIMBRADO_VIATICOS_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
) server  options(schema 'LABPROD', table 'XXAP_TIMB_VIATICOS_CTRL_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
attribute9 varchar(255),
attribute10 varchar(255)
) server  options(schema 'LABPROD', table 'XXAP_TIMB_VIATI_CTRL_DIST_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
attribute9 varchar(255),
attribute10 varchar(255)
) server  options(schema 'LABPROD', table 'XXAP_TIMB_VIATI_CTRL_TMP_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxar_control_nc_tab (
id_control numeric options (key 'true') not null,
num_anio numeric,
num_mes numeric,
...
) server  options(schema 'LABPROD', table 'XXAR_CONTROL_NC_TAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_actualizar_salario_lab (
...
id_labora numeric
) server  options(schema 'LABPROD', table 'XXHR_ACTUALIZAR_SALARIO_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_act_asig_empleados_lab (
no_empleado varchar(30),
primaria varchar(1),
plaza varchar(240),
...
fecha_interface timestamp(0),
id_labora numeric
) server  options(schema 'LABPROD', table 'XXHR_ACT_ASIG_EMPLEADOS_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_act_empleados_lab (
no_empleado varchar(30),
...
) server  options(schema 'LABPROD', table 'XXHR_ACT_EMPLEADOS_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_act_plazas_lab (
...
fecha_interface timestamp(0),
id_labora numeric(38)
) server  options(schema 'LABPROD', table 'XXHR_ACT_PLAZAS_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_crear_candidatos_lab (
idcandidato numeric,
apellido_paterno varchar(150),
apellido_materno varchar(150),
nombre varchar(150),
...
emp_keyemp numeric(38),
id_labora numeric(38)
) server  options(schema 'LABPROD', table 'XXHR_CREAR_CANDIDATOS_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_crea_plazas_lab (
clave varchar(60),
titulo varchar(60),
ubicacion varchar(60),
dpto_name varchar(240),
...
) server  options(schema 'LABPROD', table 'XXHR_CREA_PLAZAS_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_elim_empleados_lab (
no_empleado varchar(30),
...
fecha_interface timestamp(0),
id_labora numeric(38)
) server  options(schema 'LABPROD', table 'XXHR_ELIM_EMPLEADOS_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_emp_cand_lab (
no_empleado varchar(15),
fecha_contratacion timestamp(0),
estatus_interface numeric,
fecha_interface timestamp(0),
id_labora numeric
) server  options(schema 'LABPROD', table 'XXHR_EMP_CAND_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_reingresos_p (
no_empleado varchar(30),
apellido_paterno varchar(150),
apellido_materno varchar(150),
nombre varchar(150),
...
tipo_de_salario varchar(150),
submovimiento_salario varchar(150)
) server  options(schema 'LABPROD', table 'XXHR_REINGRESOS_P', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_revertir_transf_lab (
...
fecha_interface timestamp(0),
id_labora numeric
) server  options(schema 'LABPROD', table 'XXHR_REVERTIR_TRANSF_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_rever_emp_lab (
no_empleado varchar(30),
estatus_interface varchar(1),
fecha_interface timestamp(0),
id_labora numeric(38)
) server  options(schema 'LABPROD', table 'XXHR_REVER_EMP_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_transferencias_lab (
no_empleado varchar(15),
no_empleado_n varchar(15),
estatus_interface numeric,
fecha_interface timestamp(0),
id_labora numeric
) server  options(schema 'LABPROD', table 'XXHR_TRANSFERENCIAS_LAB', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_trasp_asig_candidatos (
no_empleado varchar(30),
primaria varchar(1),
plaza varchar(240),
tipo_contrato varchar(60),
...
estatus_interface varchar(1),
fecha_interface timestamp(0)
) server  options(schema 'LABPROD', table 'XXHR_TRASP_ASIG_CANDIDATOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
create foreign  table xxhr_trasp_emp_candidatos (
...
estatus_interface varchar(1),
fecha_interface timestamp(0)
) server  options(schema 'LABPROD', table 'XXHR_TRASP_EMP_CANDIDATOS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ora_status varchar(2)
) server  options(schema 'LABPROD', table 'XXPER_SIPROS_NMCODEPS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ora_secuencia numeric,
ora_status varchar(2)
) server  options(schema 'LABPROD', table 'XXPER_SIPROS_NMCOEMPL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ora_secuencia numeric,
ora_status varchar(2)
) server  options(schema 'LABPROD', table 'XXPER_SIPROS_NMCOPLZS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ora_secuencia numeric,
ora_status varchar(2)
) server  options(schema 'LABPROD', table 'XXPER_SIPROS_NMCOPUES', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ora_secuencia numeric,
ora_status varchar(2)
) server  options(schema 'LABPROD', table 'XXPER_SIPROS_NMLOCENC', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ora_secuencia numeric,
ora_status varchar(2)
) server  options(schema 'LABPROD', table 'XXPER_SIPROS_NMLODATA', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labprod,oracle,dmap_extension,public;
...
ora_secuencia numeric,
ora_status varchar(2)
) server  options(schema 'LABPROD', table 'XXPER_SIPROS_NMLOTRAY', readonly 'true');
