CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "LABPROD"."REP_INCLOCAL_VW" ("TIE_KEYEMP", "EMP_NOMEMP", "EMP_KEYPUE", "PUE_DESPUE", "EMP_KEYCEN", "CEN_DESCEN", "TIE_KEYPRO", "TIE_KEYPER", "TIE_KEYSEM", "TIE_KEYCON", "CON_DESCON", "TIE_HORDOB", "TIE_IMPDOB", "TIE_KEYUSU") AS 
