CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABPROD"."SP_NMCICDEP" (ws_nom_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,ws_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2,ws_lis_per IN VARCHAR2,ws_dep_pri IN VARCHAR2,ws_key_est IN VARCHAR2 ) IS
...
-- PGV moved types end
  ...
  ws_etq_001:='......';
	...
	INTO wn_mov_emp FROM LABPROD.nmwkmovt, LABPROD.eocorede
	...
	SELECT  COUNT( DISTINCT mov_keyemp ) alias1
	INTO wn_tot_emp FROM LABPROD.nmwkmovt, LABPROD.eocorede
