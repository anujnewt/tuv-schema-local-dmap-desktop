CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABPROD"."SP_NMMNEPYN" (ws_nom_rep IN VARCHAR2,   ws_ide_pcc IN VARCHAR2,
...
-- PGV moved types end
    ...
    ws_des_lis VARCHAR2(50)    := sp_glgetrep ('nmmneref', 'No existe nombre del Reporte', NULL);
