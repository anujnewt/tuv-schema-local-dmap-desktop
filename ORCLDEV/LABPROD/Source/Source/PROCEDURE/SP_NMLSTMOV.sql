CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABPROD"."SP_NMLSTMOV" (ws_nom_rep IN VARCHAR2,   ws_ide_pcc IN VARCHAR2,
...
-- PGV moved types end
    ...
    wn_dsp_001 NUMBER(5) := LABPROD.sp_glgetdsp1 ('nmwkmovt', 'mov_cantid', ws_key_men);
    wn_dsp_002 NUMBER(5) := LABPROD.sp_glgetdsp1 ('nmwkmovt', 'mov_import', ws_key_men);
...
EXCEPTION
    WHEN OTHERS THEN
        LABPROD.sp_glGenErr (ws_nom_rep, ws_ide_pcc, wn_key_usu, ws_hor_reg, SQLCODE, 0,
		     SUBSTR (SQLERRM, 1, 60));
END;
/
