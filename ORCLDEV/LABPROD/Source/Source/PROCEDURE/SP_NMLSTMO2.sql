CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABPROD"."SP_NMLSTMO2" (ws_nom_rep IN VARCHAR2,   ws_ide_pcc IN VARCHAR2,
					 wn_key_usu IN NUMBER, ws_key_men IN VARCHAR2,
					 ws_hor_reg IN VARCHAR2,   wn_key_pro IN NUMBER,
					 wn_key_per IN VARCHAR2,   wn_tip_rep IN NUMBER,
...
-- PGV moved types end
    ...
    wn_dsp_001 NUMBER(5) := sp_glgetdsp1 ('nmwkmovt', 'mov_cantid', ws_key_men);
    wn_dsp_002 NUMBER(5) := sp_glgetdsp1 ('nmwkmovt', 'mov_import', ws_key_men);
