CREATE OR REPLACE NONEDITIONABLE TRIGGER "LABPROD"."NMCOEMPL_SDWU" after update on LABPROD.nmcoempl
    referencing old as pre new as post
    for each row
    BEGIN
     sp_trig_empl_u(:post.emp_keyemp 
...
/
ALTER TRIGGER "LABPROD"."NMCOEMPL_SDWU" ENABLE;
