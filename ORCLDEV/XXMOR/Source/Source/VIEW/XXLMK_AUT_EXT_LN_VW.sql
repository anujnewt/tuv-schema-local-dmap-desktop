CREATE OR REPLACE FORCE EDITIONABLE VIEW "XXMOR"."XXLMK_AUT_EXT_LN_VW" ("ID_LINEA", "ID_ORDHDR", "NUM_LINEA", "CVE_CANAL", "DES_FEC_INI", "DES_FEC_FIN", "NUM_DURACION", "ID_BUYUNT", "DES_HORA_INI", "DES_HORA_FIN", "CAN_SPOTS", "CAN_LUN", "CAN_MAR", "CAN_MIE", "CAN_JUE", "CAN_VIE", "CAN_SAB", "CAN_DOM", "DES_TIPO_SERVICIO", "IND_BN", "IND_P", "DES_MARCA", "DES_VERSION", "CAN_TAR_SP_SIN_DESC", "CAN_TAR_SP_CON_DES", "CAN_TOT_LIN_SIN_DESC", "CAN_TOT_LIN_CON_DESC", "DES_SOBRECARGO", "DES_OBSERVACIONES", "DES_PLATAFORMA", "POS1", "POS2", "POS3", "POS_ANT", "POS_PEN", "POS_ULT", "FEC_CREACION", "CVE_CREADO_POR", "FEC_ACTUALIZACION", "CVE_ACTUALIZADO_POR", "DES_CAMPANA", "CAN_GRPS", "DES_SPTCHR", "DES_USRCHR", "CAN_SPOTS_X_SEM", "IND_ESTATUS", "ID_AUT", "ID_ORDEN", "IND_ESTATUS_AUT", "IND_TIPO_AUT", "IND_NIVEL", "NUM_LINEA_AUT", "DES_AUT") AS 
  SELECT
    O.ID_LINEA,
    O.ID_ORDHDR,
    O.NUM_LINEA,
