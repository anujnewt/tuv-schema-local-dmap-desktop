create or replace procedure xxmor.xxlmk_ordlmk_pkg_xxlmk_aut_rech_ord_tm_pr ( piinnum_ord numeric, a_lineas array_tvch2, piintam_arr numeric, piinind_aut_rech numeric, pistuser varchar ) as $body$
declare
