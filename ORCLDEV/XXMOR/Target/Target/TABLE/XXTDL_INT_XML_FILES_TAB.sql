-- dmap_object_gen_tag : type : table name : xxtdl_int_xml_files_tab
set search_path = xxmor,oracle,dmap_extension,public;
create table "xxtdl_int_xml_files_tab"  (
id_file_xml numeric not null,
id_request numeric,
id_service numeric,
...
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_xml_files_tab
set search_path = xxmor,oracle,dmap_extension,public;
alter table xxtdl_int_xml_files_tab add primary key (id_file_xml,fec_creation_date);
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_xml_files_tab
set search_path = xxmor,oracle,dmap_extension,public;
alter table xxtdl_int_xml_files_tab alter column fec_creation_date set not null;
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_xml_files_tab
set search_path = xxmor,oracle,dmap_extension,public;
alter table xxtdl_int_xml_files_tab alter column num_created_by set not null;
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_xml_files_tab
set search_path = xxmor,oracle,dmap_extension,public;
alter table xxtdl_int_xml_files_tab alter column fec_last_update_date set not null;
-- dmap_object_gen_tag : type : alter table name : xxtdl_int_xml_files_tab
set search_path = xxmor,oracle,dmap_extension,public;
alter table xxtdl_int_xml_files_tab alter column num_last_updated_by set not null;
