create or replace procedure fecxc."feci_inserta_rol_pr"  ( p_cod_rol varchar, p_des_rol varchar, p_usuario_creacion numeric, p_operaciones varchar, p_respuesta inout numeric ) as $body$
declare
