create or replace procedure fecxc."feci_modifica_recibo_pr"  ( p_cod_estado_recibo varchar, p_id_usuario numeric, p_folio_recibo numeric, p_tipo_recibo varchar ) as $body$
declare
