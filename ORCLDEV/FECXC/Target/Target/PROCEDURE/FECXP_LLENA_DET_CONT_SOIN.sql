create or replace procedure fecxc."fecxp_llena_det_cont_soin"  ( v_fecha_ini datedefault sysdate-12, v_version_fe numeric, v_mes_desde numeric ) as $body$
declare
...
--===============================================================================================--
--== empieza real ==--
delete from fecxp_ctas_clasif_real_soin
...
coalesce(d.ora_soin_segmento2, '000') ora_soin_segmento2,--caratula da 000 a esta cuenta
...
where e.fec_valor >= v_fecha_ini and e.fec_valor <= v_fecha_fin and e.no_empresa = coalesce(v_e_codigo, e.no_empresa)  and e.no_empresa = c.e_codigo and c.cual_erp = 'S' and m.mon_set = e.id_divisa and (to_char(e.fec_valor, 'MM'))::numeric  = m.mes and (to_char(e.fec_valor, 'YYYY'))::numeric  = m.periodo and not exists (
select 1
...
delete from fecxp_ctas_soin_caratula
where e_codigo = coalesce(v_e_codigo, e_codigo);
/* commit; */
