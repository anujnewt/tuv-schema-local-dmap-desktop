create or replace  function  fecxc.fecxc_folios_manuales_pkg_fecxc_get_subclasif_iva_fn ( piinfolio_manual numeric, pistsegmento varchar ) returns numeric as $body$
declare
