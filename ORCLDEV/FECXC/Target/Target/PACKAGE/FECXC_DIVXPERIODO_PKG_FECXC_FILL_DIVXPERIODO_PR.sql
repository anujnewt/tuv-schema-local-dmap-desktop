create or replace procedure fecxc.fecxc_divxperiodo_pkg_fecxc_fill_divxperiodo_pr ( piinidagrup numeric, piinformat numeric, pistuser varchar, piinsegment numeric ) as $body$
declare
o record;
l record;
j record;
...
loop
perform dbms_output.put_line( concat('k:', k)) ;/* dmap converted statement end *//* dmap converted statement start */
