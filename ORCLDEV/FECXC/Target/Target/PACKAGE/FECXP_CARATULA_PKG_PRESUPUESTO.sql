create or replace procedure fecxc.fecxp_caratula_pkg_presupuesto () as $body$
declare
...
a.moneda, a.tipo_cambio, b.cla_fe_id, oracle.substr(b.cla_fe_des, 1, 25) cla_fe_des, sum(a.importe_linea*(b.cla_atributo3::numeric)::numeric )
...
begin
insert	into fecxp_ppto_caratula(e_codigo, des_empresa, id_sesion_pc, periodo, mes, moneda, tipo_cambio, cla_fe_id, cla_fe_des, importe_linea)
select	a.e_codigo, a.des_empresa, v_id_sesion, a.periodo, a.mescod, a.mon_oracle, a.tipo_cambio, b.cla_fe_id, oracle.substr(b.cla_fe_des, 1, 25), sum(a.importe_linea* (b.cla_atributo3::numeric)::numeric )
...
select	e.e_codigo, e.des_empresa, 1 v_id_sesion, (to_char(d.fecha, 'YYYY'))::numeric , d.mes, d.moneda_imp, m.tipo_cambio, c.cla_fe_id, oracle.substr(c.cla_fe_des, 1, 25), (c.cla_atributo3)::numeric  * d.importe_linea, 'IMPORTADO'
