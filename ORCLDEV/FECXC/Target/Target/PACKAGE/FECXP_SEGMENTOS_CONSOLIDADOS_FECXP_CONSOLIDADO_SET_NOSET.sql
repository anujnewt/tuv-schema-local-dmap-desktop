create or replace procedure fecxc.fecxp_segmentos_consolidados_fecxp_consolidado_set_noset (id_segmento numeric) as $body$
declare
-- pgv moved types start
-- pgv moved types end
recorre_cursor numeric;
c_emp_set cursor for select id_emp from  fecxc.fecxp_emp_no_set;
begin
