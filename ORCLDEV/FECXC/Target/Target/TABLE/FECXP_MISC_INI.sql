-- dmap_object_gen_tag : type : table name : fecxp_misc_ini
set search_path = fecxc,oracle,dmap_extension,public;
create table "fecxp_misc_ini"  (
...
-- dmap_object_gen_tag : type : alter table name : fecxp_misc_ini
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_misc_ini alter column no_empresa set not null;
-- dmap_object_gen_tag : type : alter table name : fecxp_misc_ini
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_misc_ini alter column no_folio_det set not null;
-- dmap_object_gen_tag : type : alter table name : fecxp_misc_ini
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_misc_ini alter column secuencia_dep_especiales set not null;
