-- dmap_object_gen_tag : type : table name : fecxp_imp_datos_bitacora
set search_path = fecxc,oracle,dmap_extension,public;
create table "fecxp_imp_datos_bitacora"  (
...
-- dmap_object_gen_tag : type : alter table name : fecxp_imp_datos_bitacora
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_imp_datos_bitacora alter column tipo_empresa_imp set not null;
