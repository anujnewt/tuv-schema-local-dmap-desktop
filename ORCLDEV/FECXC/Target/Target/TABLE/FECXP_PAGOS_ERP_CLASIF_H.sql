-- dmap_object_gen_tag : type : table name : fecxp_pagos_erp_clasif_h
set search_path = fecxc,oracle,dmap_extension,public;
create table "fecxp_pagos_erp_clasif_h"  (
...
-- dmap_object_gen_tag : type : alter table name : fecxp_pagos_erp_clasif_h
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_pagos_erp_clasif_h alter column e_codigo set not null;
-- dmap_object_gen_tag : type : alter table name : fecxp_pagos_erp_clasif_h
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_pagos_erp_clasif_h alter column folio_set set not null;
-- dmap_object_gen_tag : type : alter table name : fecxp_pagos_erp_clasif_h
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_pagos_erp_clasif_h alter column tipo_operacion set not null;
-- dmap_object_gen_tag : type : alter table name : fecxp_pagos_erp_clasif_h
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_pagos_erp_clasif_h alter column numero_de_partida_erp set not null;
