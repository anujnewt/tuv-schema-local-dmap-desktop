CREATE OR REPLACE EDITIONABLE PROCEDURE "FECXC"."FECI_INSERTA_RECIBO_MANUAL_PR" 
(
        p_FECHA         DATE,
        p_MONEDA         VARCHAR2,
        p_EMPRESA         VARCHAR2,
     ...
     INSERT INTO FECXC.FECI_RECIBO_MANUAL_TAB
        (
            ...
            ID_USUARIO_ULT_MODIF,IND_ESTADO,COD_CLIENTE)
             ...
             NULL,NULL,NULL,NULL,NULL,NULL,'CLSF',SYSDATE,SYSDATE,p_USUARIO,0,1,p_COD_CLIENTE
             )
             returning FOLIO_RECIBO_MANUAL INTO ID_REGISTRO;
            FECXC.FECI_MODIFICA_TIPO_CAMBIO_RECIBO_PR(ID_REGISTRO, 'MANUAL', p_Usuario);
