CREATE OR REPLACE EDITIONABLE PROCEDURE "FECXC"."FECI_OBTENER_RECIBOS_PRUEBA" 
(
    p_VER VARCHAR2,
    p_FECHA_INICIO DATE,
    p_FECHA_FIN DATE,
...
BEGIN
  ...
  v_query := 'SELECT * FROM FECXC.FECI_RECIBOS_VW WHERE COD_ESTADO_RECIBO IN (' || p_VER || ')
...
END FECI_OBTENER_RECIBOS_PRUEBA;
/
