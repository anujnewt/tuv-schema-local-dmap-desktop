...
folio_recibo_manual  bigint generated always as identity  (start with 130 increment by 1  maxvalue 999999999999999999 minvalue 1 no cycle cache 20 ),
...
-- dmap_object_gen_tag : type : alter table name : feci_recibo_manual_tab
set search_path = fecxc,oracle,dmap_extension,public;
alter table feci_recibo_manual_tab alter column ref_cliente set not null;
-- dmap_object_gen_tag : type : alter table name : feci_recibo_manual_tab
set search_path = fecxc,oracle,dmap_extension,public;
alter table feci_recibo_manual_tab alter column nom_cliente set not null;
-- dmap_object_gen_tag : type : alter table name : feci_recibo_manual_tab
set search_path = fecxc,oracle,dmap_extension,public;
alter table feci_recibo_manual_tab alter column clase_cliente set not null;
-- dmap_object_gen_tag : type : alter table name : feci_recibo_manual_tab
set search_path = fecxc,oracle,dmap_extension,public;
alter table feci_recibo_manual_tab alter column metodo_pago set not null;
-- dmap_object_gen_tag : type : alter table name : feci_recibo_manual_tab
set search_path = fecxc,oracle,dmap_extension,public;
