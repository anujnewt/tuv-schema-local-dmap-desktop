-- dmap_object_gen_tag : type : table name : fecxp_importacion_datos_hist_r
set search_path = fecxc,oracle,dmap_extension,public;
create table "fecxp_importacion_datos_hist_r"  (
...
-- dmap_object_gen_tag : type : alter table name : fecxp_importacion_datos_hist_r
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_importacion_datos_hist_r alter column tipo_empresa_imp set not null;
