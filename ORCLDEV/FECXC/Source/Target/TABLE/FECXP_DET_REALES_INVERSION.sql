-- dmap_object_gen_tag : type : table name : fecxp_det_reales_inversion
set search_path = fecxc,oracle,dmap_extension,public;
create table "fecxp_det_reales_inversion"  (
...
-- dmap_object_gen_tag : type : alter table name : fecxp_det_reales_inversion
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_det_reales_inversion alter column e_codigo set not null;
-- dmap_object_gen_tag : type : alter table name : fecxp_det_reales_inversion
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_det_reales_inversion alter column folio_set set not null;
-- dmap_object_gen_tag : type : alter table name : fecxp_det_reales_inversion
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_det_reales_inversion alter column tipo_operacion set not null;
-- dmap_object_gen_tag : type : alter table name : fecxp_det_reales_inversion
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxp_det_reales_inversion alter column numero_de_partida_erp set not null;
