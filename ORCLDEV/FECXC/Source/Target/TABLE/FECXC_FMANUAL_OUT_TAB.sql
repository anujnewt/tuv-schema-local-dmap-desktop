-- dmap_object_gen_tag : type : table name : fecxc_fmanual_out_tab
set search_path = fecxc,oracle,dmap_extension,public;
create table "fecxc_fmanual_out_tab"  (
...
-- dmap_object_gen_tag : type : alter table name : fecxc_fmanual_out_tab
set search_path = fecxc,oracle,dmap_extension,public;
alter table fecxc_fmanual_out_tab alter column cod_sec_clasifica set not null;
