create or replace procedure fecxc."feci_inserta_usuario_pr"  ( p_id_rol numeric, p_email varchar, p_nombres varchar, p_apellidos varchar, p_estatus numeric, p_usuario_alta numeric, p_array varchar, p_id_usuario inout numeric ) as $body$
declare
