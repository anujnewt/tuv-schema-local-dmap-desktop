create or replace  function  fecxc.fecxc_folios_manuales_pkg_fecxc_get_subclasif_iva_int_fn ( piinfolio_manual numeric, pistsegmento varchar ) returns numeric as $body$
declare
...
then perform dbms_output.put_line( concat(sqlerrm, ' No existe informacion para este registro FECXC_GET_SUBCLASIF_IVA_FN Folio: ', piinfolio_manual)) ;/* dmap converted statement end */
end;
