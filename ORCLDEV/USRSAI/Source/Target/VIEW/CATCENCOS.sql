-- dmap_object_gen_tag : type : view name : catcencos
set search_path = usrsai,oracle,dmap_extension,public;/* dmap converted statement start */
create or replace view "catcencos"  ("cdc_keydep", "cdc_desdep", "cdc_tipprog", "cdc_desprog", "cdc_nomresp", "cdc_duracion", "cdc_idioma") as select distinct x0.dep_keydep , x0.dep_desdep , x1.ald_keytpr
...
-- estimed cost of view [ catcencos ]: 1.00;
