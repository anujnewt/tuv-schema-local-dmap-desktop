create or replace procedure usrsai."sp_updnopetanr_sa"  ( numsol numeric, idereg numeric, numpcanr numeric, aux inout numeric) as $body$
declare
...
from detsolact
where nullif(dsa_npcanr::text, '') is null and dsa_numsol = numsol;
if aux2 = 0 then
update encsolact
set esa_stssol = 4
