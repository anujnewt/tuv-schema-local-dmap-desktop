create or replace procedure xx_bloqueobajas.bloqueoaccesos_autorizacion (p_idsolicitud numeric, p_usuario varchar, p_ip varchar, p_nombrepc varchar, p_resp inout numeric, p_mensaje inout varchar) as $body$
declare
...
update xx_bloqueobajas.solicitudes set estatus = 2, usuarioaccion = upper(p_usuario), fechaaccion = clock_timestamp(),
