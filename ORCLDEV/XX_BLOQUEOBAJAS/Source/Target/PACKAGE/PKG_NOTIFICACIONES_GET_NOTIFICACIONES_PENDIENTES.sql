create or replace procedure xx_bloqueobajas.pkg_notificaciones_get_notificaciones_pendientes (p_tipo numeric, p_result inout refcursor) as $body$
declare
...
coalesce(usu.correo,'__') correo_solicitante,  --correo del solicitante
