create or replace procedure labppto."sp_glgenerr"  (ws_nom_rep varchar, ws_ide_pcc varchar, wn_key_usu numeric, ws_hor_reg varchar, wn_sql_err numeric, wn_isa_err numeric, ws_des_err varchar) as $body$
declare
