CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "LABCONF"."PB_MOVIMIENTOS" ("FECHA_CAPTURA", "EMP_KEYEMP", "NOMBRE", "FECHA_MOVIMIENTO", "TIPO_MOVIMIENTO", "PLZ_ACT", "PLZ_ANT", "DPTO_ACT", "DPTO_ANT", "PTO_ACT", "PTO_ANT") AS 
