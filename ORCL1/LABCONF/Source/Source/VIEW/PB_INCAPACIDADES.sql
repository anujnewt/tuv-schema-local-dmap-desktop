CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "LABCONF"."PB_INCAPACIDADES" ("FECHA_CAPTURA", "KEYEMP", "NOMBRE", "TIPO_INCAPACIDAD", "FECHA_INICIO", "FECHA_FINAL", "DIAS_INCAPACIDAD", "PROCESO", "DESC_PROCESO") AS 
