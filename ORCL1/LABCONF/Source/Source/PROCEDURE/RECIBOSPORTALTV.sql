CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABCONF"."RECIBOSPORTALTV" (
...
-- PGV moved types start
      ...
      begin
       ...
       exception
        ...
        COMMIT;
        v_nrCheckSum := 0;
        INSERT INTO LABCONF.tt_v_selEmpls VALUES (v_keyemp);
        commit;
        IF v_KeyNom = 25 THEN
            ...
            OPEN CV_EMPDETAILS FOR
                ...
                SELECT  his_keyemp,
                  ...
                  FROM (
                      SELECT his_keyemp,
                        ...
                        CAST(HIS_CODIMP AS NUMBER) HIS_CODIMP,
              ...
              GROUP BY his_keyemp, SEC_ROW --, per_keycon, ded_keycon
               ...
               JOIN
                ...
                AND per_keyper                        = v_KeyPer )
                and his_keyemp = v_KeyEmp
                --AND ( v_nrCheckSum = 0 OR acu_keyemp IN (SELECT KEYEMP FROM LABCONF.tt_v_selEmpls) )
