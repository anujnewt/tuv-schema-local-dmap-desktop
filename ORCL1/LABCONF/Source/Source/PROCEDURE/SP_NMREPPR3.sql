CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABCONF"."SP_NMREPPR3" (ws_nom_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,wn_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2,ws_sta_tu1 IN VARCHAR2,ws_sta_tu2 IN VARCHAR2,ws_sta_tu3 IN VARCHAR2,ws_sta_tu4 IN VARCHAR2,wn_key_pro IN NUMBER,ws_des_pro IN VARCHAR2 ) IS
...
-- PGV moved types end
	...
	INTO wn_tot_reg FROM LABCONF.nmlopres
 ...
 WHEN NO_DATA_FOUND THEN
  ...
  ws_etq_001:='........';
	...
	END IF;
		...
		END IF;
	END LOOP;
	LABCONF.sp_glnewdsp('nmlopres', 'pre_keycon', ws_key_men,wn_dsp_001);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_keyemp', ws_key_men,wn_dsp_003);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_fecreg', ws_key_men,wn_dsp_005);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_unipre', ws_key_men,wn_dsp_006);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_imppre', ws_key_men,wn_dsp_007);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_unisal', ws_key_men,wn_dsp_008);
	LABCONF.sp_glnewdsp('nmlopres', 'per_impsal', ws_key_men,wn_dsp_009);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_plazop', ws_key_men,wn_dsp_010);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_porint', ws_key_men,wn_dsp_011);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_numpag', ws_key_men,wn_dsp_012);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_perini', ws_key_men,wn_dsp_013);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_status', ws_key_men,wn_dsp_014);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_refere', ws_key_men,wn_dsp_015);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_unides', ws_key_men,wn_dsp_016);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_impdes', ws_key_men,wn_dsp_017);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_uniamo', ws_key_men,wn_dsp_018);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_impamo', ws_key_men,wn_dsp_019);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_gastos', ws_key_men,wn_dsp_020);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_fecini', ws_key_men,wn_dsp_021);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_fecaut', ws_key_men,wn_dsp_022);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_cveaut', ws_key_men,wn_dsp_023);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_fechab', ws_key_men,wn_dsp_024);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_fe1aux', ws_key_men,wn_dsp_025);
	LABCONF.sp_glnewdsp('nmlopres', 'pre_fe2aux', ws_key_men,wn_dsp_026);
	wn_pro_ant:=-32760;
	wn_nom_ant:=-32760;
	wn_num_reg:=0;
	wn_pct_act:=1;
