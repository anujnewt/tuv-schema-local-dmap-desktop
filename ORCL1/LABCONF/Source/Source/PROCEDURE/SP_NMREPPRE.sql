CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABCONF"."SP_NMREPPRE" (ws_nom_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,wn_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2,ws_sta_tu1 IN VARCHAR2,ws_sta_tu2 IN VARCHAR2,ws_sta_tu3 IN VARCHAR2,ws_sta_tu4 IN VARCHAR2,wn_key_pro IN NUMBER,ws_des_pro IN VARCHAR2 ) IS
