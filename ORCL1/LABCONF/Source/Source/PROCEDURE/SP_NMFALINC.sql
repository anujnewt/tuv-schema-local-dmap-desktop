CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABCONF"."SP_NMFALINC" (ws_nom_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,wn_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2,ws_fec_ha1 IN VARCHAR2,ws_fec_ha2 IN VARCHAR2 ) IS
...
EXCEPTION
 WHEN NO_DATA_FOUND THEN
  ...
  wn_ant_emp:=wn_key_emp;
	...
	ws_des_ims:='No Existe Descripción  ...';
