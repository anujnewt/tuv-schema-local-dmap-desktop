CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABCONF"."SP_NMLSTMO4" (ws_nom_rep IN VARCHAR2,ws_ide_pcc IN VARCHAR2,wn_key_usu IN  NUMBER,ws_key_men IN VARCHAR2,ws_hor_reg IN VARCHAR2,wn_key_pro IN NUMBER,ws_key_per IN VARCHAR2,wn_tip_rep IN NUMBER,ws_nom_rp1 IN VARCHAR2 ) IS
...
-- PGV moved types end
	...
	LABCONF.sp_glGetDsp('nmwkmovt', 'mov_cantid', ws_key_men,wn_dsp_001);
	LABCONF.sp_glGetDsp('nmwkmovt', 'mov_import', ws_key_men,wn_dsp_002);
