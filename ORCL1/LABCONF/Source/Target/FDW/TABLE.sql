...
idcomprobanteemp numeric(10) options (key 'true') not null,
qrcode bytea
) server  options(schema 'LABCONF', table 'CFDI2QR', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labconf,oracle,dmap_extension,public;
...
) server  options(schema 'LABCONF', table 'DETALLEPARAMETROS', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labconf,oracle,dmap_extension,public;
...
emp_finfec timestamp(0),
emp_cobert varchar(2)
) server  options(schema 'LABCONF', table 'NMCOEMPL', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labconf,oracle,dmap_extension,public;
...
) server  options(schema 'LABCONF', table 'NMLOACUM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labconf,oracle,dmap_extension,public;
...
) server  options(schema 'LABCONF', table 'NMLOHISM', readonly 'true');
-- dmap_object_gen_tag : type : fdw name : table
set search_path = labconf,oracle,dmap_extension,public;
