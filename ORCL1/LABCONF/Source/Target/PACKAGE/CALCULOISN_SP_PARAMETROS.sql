create or replace procedure labconf.calculoisn_sp_parametros (ws_nom_rep varchar, ws_key_per inout varchar, wn_anio inout integer, wn_mes inout integer, wn_key_nom inout smallint) as $body$
declare
