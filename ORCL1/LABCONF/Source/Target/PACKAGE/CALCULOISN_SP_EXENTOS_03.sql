create or replace procedure labconf.calculoisn_sp_exentos_03 (ws_nom_rep varchar,ws_key_per varchar, wn_anio integer, wn_mes integer, wn_key_nom smallint) as $body$
declare
