create or replace procedure labconf.utils_dmap_test_onetime_block_init () as $body$
declare
...
l_one_time_block_invoked := dmap_extension.f_dmap_get_pkg_var('LABCONF','UTILS', 'ONE_TIME_BLOCK_INVOKED', null);
...
call dmap_extension.p_dmap_set_pkg_var('LABCONF','UTILS', 'ONE_TIME_BLOCK_INVOKED', null, null, 'Y');
end if;
exception
when others then
