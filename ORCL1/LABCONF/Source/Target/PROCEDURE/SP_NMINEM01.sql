create or replace procedure labconf."sp_nminem01"  (ws_nom_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar,ws_nom_ran varchar ) as $body$
declare
...
into strict wn_tot_reg from labconf.nmcoinci
where inc_keyinc in (
...
wn_dsp_008:=0;
wn_dsp_009:=0;
call labconf.sp_glnewdsp ('nmcoinci', 'inc_keypro', ws_key_men,wn_dsp_001);
call labconf.sp_glnewdsp ('nmcoinci', 'inc_keyper', ws_key_men,wn_dsp_002);
call labconf.sp_glnewdsp ('nmcoinci', 'inc_keyemp', ws_key_men,wn_dsp_003);
call labconf.sp_glnewdsp ('nmcoinci', 'inc_keycon', ws_key_men,wn_dsp_004);
call labconf.sp_glnewdsp ('nmcoinci', 'inc_cantid', ws_key_men,wn_dsp_005);
call labconf.sp_glnewdsp ('nmcoinci', 'inc_import', ws_key_men,wn_dsp_006);
call labconf.sp_glnewdsp ('nmcoinci', 'inc_fecmov', ws_key_men,wn_dsp_007);
call labconf.sp_glnewdsp ('nmcoinci', 'inc_keydep', ws_key_men,wn_dsp_008);
call labconf.sp_glnewdsp ('nmcoinci', 'inc_keypue', ws_key_men,wn_dsp_009);
wn_ant_emp:=-0000;
ws_ant_con:='______';
wn_ant_pro:=-0000;
ws_ant_dep:=0;
