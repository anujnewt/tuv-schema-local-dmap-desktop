create or replace procedure labconf."sp_nmindi02"  (ws_nom_rep varchar, ws_ide_pcc varchar, wn_key_usu numeric, ws_key_men varchar, ws_hor_reg varchar) as $body$
declare
...
insert into labconf.glwkcrys(cry_nomrep, cry_idepcc, cry_keyusu, cry_chr001, cry_dec006, cry_chr017,
