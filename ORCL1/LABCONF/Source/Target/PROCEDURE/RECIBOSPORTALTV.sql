create or replace procedure labconf."recibosportaltv"  ( v_keybin varchar, keypro numeric, keyper varchar, keyemp numeric, cv_empdetails inout refcursor ) as $body$
declare
-- pgv moved types end
/*keypro  proceso
keyper  periodo */
...
/* commit; */
v_nrchecksum := 0;
insert into labconf.tt_v_selempls values (v_keyemp);/* dmap converted statement start */
/* commit; */
if v_keynom = 25 then
