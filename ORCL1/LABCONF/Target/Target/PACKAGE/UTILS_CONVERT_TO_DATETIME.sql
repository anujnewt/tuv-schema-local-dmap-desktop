create or replace  function  labconf.utils_convert_to_datetime (p_expr varchar , p_precision numeric default 0, p_scale numeric default 0, p_style numeric default null) returns ts as $body$
declare
