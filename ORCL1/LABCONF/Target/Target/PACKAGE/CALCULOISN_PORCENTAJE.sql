create or replace  function  labconf.calculoisn_porcentaje (ws_key_ent varchar,wn_por_cen numeric,ws_key_tab varchar,wn_base numeric) returns numeric as $body$
declare
