create or replace procedure labconf."sp_nmlstctt"  (ws_nom_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar ) as $body$
declare
...
select pam_nompar
into strict ws_etq_007 from glcopams
