create or replace procedure labconf."sp_calculofinal"  (wn_key_pro numeric, ws_key_per varchar, ws_nom_rep varchar, ws_fec_ini varchar, ws_hor_ini varchar) as $body$
declare
...
values (ws_nom_rep,-1,wn_key_pro,ws_key_per,'Calculo final', ws_fec_ini,ws_hor_ini,result);end;
$body$
language plpgsql
;
