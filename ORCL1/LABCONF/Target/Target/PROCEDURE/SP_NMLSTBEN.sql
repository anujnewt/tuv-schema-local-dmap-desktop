create or replace procedure labconf."sp_nmlstben"  ( ws_nom_rep varchar, ws_ide_pcc varchar, wn_key_usu numeric, ws_key_men varchar, ws_hor_reg varchar, vs_tip_ben varchar) as $body$
declare
