create or replace procedure labconf."sp_nmlstnm2a"  (ws_nom_rep varchar,ws_des_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar,wn_key_pro numeric,wn_tip_nom numeric,ws_key_per varchar ) as $body$
declare
...
where pam_keypar = (
select distinct pam_folini from labconf.glcopams
where pam_keypar='00'
...
k:=1;
for c_nmlstnom in ( select mov_keyemp, mov_keycon, mov_cantid, mov_import, mov_codimp from labconf.nmwkmovt
