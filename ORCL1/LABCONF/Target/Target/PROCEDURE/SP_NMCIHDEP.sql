create or replace procedure labconf."sp_nmcihdep"  (ws_nom_rep varchar,ws_ide_pcc varchar,ws_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar,ws_lis_per varchar,ws_dep_pri varchar,ws_key_est varchar ) as $body$
declare
...
into strict ws_cod_pri from labconf.eocorede
...
into strict wn_mov_emp from labconf.nmlohism, labconf.eocorede
...
from labconf.nmlohism, labconf.eocorede
...
into strict ws_lis_pro, ws_lis_pr2, ws_lis_pr3 from labconf.glwkrang
...
begin select  count( distinct his_keyemp ) alias1
into strict wn_tot_emp from labconf.nmlohism, labconf.eocorede
...
into strict ws_lis_nom from labconf.glwkrang
where ran_nomrep=ws_nom_rep
and ran_idepcc=ws_ide_pcc
and ran_keyusu=ws_key_usu;
exception
