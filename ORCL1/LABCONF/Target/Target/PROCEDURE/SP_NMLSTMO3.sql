create or replace procedure labconf."sp_nmlstmo3"  (ws_nom_rep varchar,ws_ide_pcc varchar,wn_key_usu numeric,ws_key_men varchar,ws_hor_reg varchar,wn_key_pro numeric,ws_key_per varchar,wn_tip_rep numeric,ws_nom_rp1 varchar ) as $body$
declare
...
c_nmlstcic record;
begin
call labconf.sp_glnewdsp ('nmwkmovt', 'mov_cantid', ws_key_men,wn_dsp_001);
call labconf.sp_glnewdsp ('nmwkmovt', 'mov_import', ws_key_men,wn_dsp_002);
...
ws_opc_009:= null;
begin
select pam_folini into strict ws_opc_009 from labconf.glcopams
...
into strict ws_nom_emp,wd_fec_antig,wd_fec_baj from labconf.nmcoempl
