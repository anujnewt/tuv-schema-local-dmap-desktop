CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABCONF"."SP_CALCULOINICIO" (wn_key_pro IN NUMBER, ws_key_per IN varchar, ws_nom_rep IN varchar, ws_fec_ini IN varchar, ws_hor_ini IN varchar)
AS
