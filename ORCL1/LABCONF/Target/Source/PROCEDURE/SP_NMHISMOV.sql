CREATE OR REPLACE NONEDITIONABLE PROCEDURE "LABCONF"."SP_NMHISMOV" (ws_nom_rep IN VARCHAR2,   ws_ide_pcc IN VARCHAR2,
...
BEGIN
	 -- Variables para las restricciones de despliegue.
	LABCONF.sp_glgetdsp('nmlohism', 'his_keyemp', ws_key_men,wn_dsp_001);
	LABCONF.sp_glgetdsp('nmlohism', 'his_keycon', ws_key_men,wn_dsp_002);
	LABCONF.sp_glgetdsp('nmlohism', 'his_cantid', ws_key_men,wn_dsp_003);
	LABCONF.sp_glgetdsp('nmlohism', 'his_import', ws_key_men,wn_dsp_004);
	LABCONF.sp_glgetdsp('nmlohism', 'his_keyper', ws_key_men,wn_dsp_005);
