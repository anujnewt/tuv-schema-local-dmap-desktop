CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "LABCONF"."VCFDI2REPORTEDETALLE" ("IDCOMPROBANTEEMP", "IDNOMINA", "COM_KEYPRO", "COM_KEYPER", "NUMROW", "COM_KEYEMP", "COM_CODIMP", "TIPO", "DESCTIPO", "CLAVE", "CONCEPTO", "IMPORTEGRAVADO", "IMPORTEEXENTO") AS 
